...
{
    public partial class FrmRelatorioPOrcamento : Form
    {
        ...
        public LIS_ORCAMENTOCollection LIS_ORCAMENTOCollRelatPers = new LIS_ORCAMENTOCollection();
        ...
        private void GetDropRelatorio()
        {
            ...
            RowsFiltro.Add(new RowsFiltro("IDTELA", "System.Int32", "=", "11"));
        ...
        private void AddColPersonalizada()
        {
            ...
            if (CampoOrdenar != string.Empty)
            {
                ...
                LIS_ORCAMENTOCollRelatPers.Sort(comparer.Comparer);                
            }

            ////adiciona uma linha no rodape do grid
            LIS_ORCAMENTOEntity AddLinha = new LIS_ORCAMENTOEntity();
            AddLinha.IDORCAMENTO = null;
            LIS_ORCAMENTOCollRelatPers.Add(AddLinha);

            DataGridPerson.DataSource = LIS_ORCAMENTOCollRelatPers;
            PercorreDataGrid();          
        }
