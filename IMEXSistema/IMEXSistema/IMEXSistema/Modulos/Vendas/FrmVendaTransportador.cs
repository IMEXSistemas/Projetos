...
{
    public partial class FrmVendaTransportador : Form
    {
        ...
        private void PreencheGrid()
        {
            ...
            foreach (var LIS_PEDIDOTy in LIS_PEDIDOColl)
            {
                ...
                row1_2.CreateCells(DataGriewDados, "", "TRANSP.", LIS_PEDIDOTy.NOMETRANSPORTES, "", "", "", "");
        ...
        {
            string RelatorioTitulo = InputBox("Título do Relatório", ConfigSistema1.Default.NomeEmpresa, "Lista de Vendas por Transportador");
        ...
        private void btnPesquisa_Click(object sender, EventArgs e)
        {
            if (Validacoes())
            {
                try
                {
                    ...
                    if (Convert.ToInt32(cbFuncionario.SelectedValue) > 0)
                        LIS_PEDIDOColl = LIS_PEDIDOP.ReadCollectionByParameter(RowRelatorio, "IDTRANSPORTES, IDPEDIDO");
                    else
