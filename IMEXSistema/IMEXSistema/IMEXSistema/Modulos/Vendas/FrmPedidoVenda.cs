    ...
    public partial class FrmPedidoVenda : Form
    {
       ...
       public int _IDPEDIDO = -1;
        public PEDIDOEntity Entity
        {
            get
            {
                ...
                return new PEDIDOEntity(_IDPEDIDO, IDCLIENTE, DTEMISSAO, IDSTATUS, PRAZOENTREGA,
                                        ...
                                        FLAGORCAMENTO, NREFERENCIA, FLAGVLMETRO, OBSANEXO, DataEntrega,
        ...
        public PRODUTOSPEDIDOEntity Entity2
        {
            get
            {
              ...
              int? IDCOR = null;
                ...
                decimal? TOTALMT = Convert.ToDecimal(txtTotalMTLinear.Text);
                string FLAGEXIBIR = chkExibirProd.Checked ? "N" : "S";

                string DADOSADICIONAIS = txtDadosAdicionais1.Text;

                decimal ALTURA  = Convert.ToDecimal(txtAltLinear.Text);
                decimal LARGURA = Convert.ToDecimal(txtLargLinear.Text);

                int? IDAMBIENTE = null;
                if (Convert.ToInt32(cbAmbiente.SelectedValue) > 0)
                    IDAMBIENTE = Convert.ToInt32(cbAmbiente.SelectedValue);

                decimal PORCPERDAMT = Convert.ToDecimal(txtPorcPerdMT.Text);
                decimal TOTALPERDAMT = Convert.ToDecimal(TotalPerdaMT.Text);
                ...
                return new PRODUTOSPEDIDOEntity(_IDPRODPEDIDO, _IDPEDIDO, IDPRODUTO,
                                                ...
                                                IDAMBIENTE, _IDPRODUTOMASTER, PORCPERDAMT, TOTALPERDAMT,
            ...
            set
            {
                ...
                if (value != null)
                {
                    ...
                    txtTotalMTLinear.Text = Convert.ToDecimal(value.TOTALMT).ToString("N3");
                    chkExibirProd.Checked = value.FLAGEXIBIR.TrimEnd() == "N" ? true : false;
                    txtDadosAdicionais1.Text = value.DADOSADICIONAIS;

                    txtAltLinear.Text = Convert.ToDecimal(value.ALTURA).ToString("n4");
                    txtLargLinear.Text = Convert.ToDecimal(value.LARGURA).ToString("n4");
                    ...
                    txtValorMtLinearTotal.Text = Convert.ToDecimal(value.VALORTOTAL).ToString("n2");
                    txtPorcPerdMT.Text = Convert.ToDecimal(value.PORCPERDAMT).ToString("n2");
                    TotalPerdaMT.Text = Convert.ToDecimal(value.TOTALPERDAMT).ToString("n4");
                    SomaPerdaMT();
                ...
                else
                {
                    ...
                    txtAltLinear.Text = "0,0000";
                    txtLargLinear.Text = "0,0000";
                    txtTotalMTLinear.Text = "0,0000";
                    ...
                    txtPorcPerdMT.Text = "0,00";
                    TotalPerdaMT.Text = "0,0000";
                    SomaPerdaMT();
        ...
        public PRODUTOSPEDIDOMTQEntity Entity6
        {
            get
            {
                ...
                return new PRODUTOSPEDIDOMTQEntity(_IDPRODUTOSPEDIDOMTQ, _IDPEDIDO, IDPRODUTO,
                                                  ...
                                                  FLAGEXIBIR, DADOSADICIONAIS, IDAMBIENTE, _IDPRODUTOMASTER,
                                                  PORCPERDA, TOTALPERDA);
            }
            set
            {
        ...
        private Boolean ValidacoesProdutos()
        {
            ...
            {
                if (Convert.ToDecimal(txtTotalMTLinear.Text) > 0)
                {
                    if (Convert.ToDecimal(txtEstoqueMTLinear.Text) < (Convert.ToDecimal(txtTotalMTLinear.Text) * Convert.ToDecimal(txtQuanProduto.Text)))
                    {
                        string Msgerro = "Estoque não pode ficar negativo!";
                        errorProvider1.SetError(txtTotalMTLinear, Msgerro);
                        errorProvider1.SetError(txtEstoqueMTLinear, Msgerro);
                        Util.ExibirMSg(Msgerro, "Red");
                        result = false;
                    }
                }
                ...
                {
                    if (Convert.ToDecimal(txtEstoqueMTLinear.Text) <  Convert.ToDecimal(txtQuanProduto.Text))
                    {
                        string Msgerro = "Estoque não pode ficar negativo!";
        ...
        private void AddProdutoComposicaoMTLinear(int IDCOMPOSICAO)
        {
        ...
        private void cbProduto_SelectedValueChanged(object sender, EventArgs e)
        {
            if (cbProduto.SelectedIndex > 0)
            {
                ...
                if (PRODUTOS_EstoqTy.PORCPERDAPROD != null)
                    txtPorcPerdMT.Text = Convert.ToDecimal(PRODUTOS_EstoqTy.PORCPERDAPROD).ToString("n3");
        ...
        private void printDocument2_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (CONFISISTEMAty.FLAGLOGORELATORIO == "S")
            {
                if (CONFISISTEMAty.IDARQUIVOBINARIO1 != null)
                {
                    ...
                    e.Graphics.DrawImage(System.Drawing.Image.FromStream(stream), config.MargemEsquerda + 570, 38);
                }
            }
            ...
            System.Drawing.Font FonteDescr = new System.Drawing.Font("Arial", 7);
            ...
            while (IndexRegistro < LIS_PRODUTOSPEDIDOColl.Count)
            {
                 ...
                 e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : Convert.ToDecimal(LIS_PRODUTOSPEDIDOColl[IndexRegistro].VALORUNITARIO).ToString("n4"), config.FonteNormal, Brushes.Black, config.MargemEsquerda + 630, linha + 15, stringFormat);

                 e.Graphics.DrawRectangle(config.CanetaDaImpressora, config.MargemEsquerda + 10, linhaBorda, config.MargemDireita - 20, 20);
                 e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : Convert.ToDecimal(LIS_PRODUTOSPEDIDOColl[IndexRegistro].VALORTOTAL).ToString("n2"), config.FonteNormal, Brushes.Black, config.MargemEsquerda + 730, linha + 15, stringFormat);
                 linha = linha + 20;
            ...
            try
            {
                ...
                if (CONFISISTEMAty.FLAGLOGORELATORIO == "S")
                {
                    if (CONFISISTEMAty.IDARQUIVOBINARIO1 != null)
                    {
                        ...
                        //'Imagem
                        e.Graphics.DrawImage(System.Drawing.Image.FromStream(stream), config.MargemEsquerda + 550, 68);
                    }
                }
            ...
            try
            {
                ...
                if (CONFISISTEMAty.FLAGLOGORELATORIO == "S")
                {
                    if (CONFISISTEMAty.IDARQUIVOBINARIO1 != null)
                    {
                        ...
                        e.Graphics.DrawImage(System.Drawing.Image.FromStream(stream), config.MargemEsquerda + 570, 518);
                    }
                }
        ...
        private void cbProdutoMTQ_SelectedValueChanged(object sender, EventArgs e)
        {
            if (cbProdutoMTQ.SelectedIndex > 0)
            {
                ...
                txtAlturaMTQ.Text = Convert.ToDecimal(PRODUTOS_EstoqTy.ALTURACHAPA).ToString("n4");
                txtLarguraMTQ.Text = Convert.ToDecimal(PRODUTOS_EstoqTy.LARGURACHAPA).ToString("n4");
                SomaUnitMTQ();
            }
        }
        ...
        private void SomaPerdaMT()
        {
            try
            {
                if (ValidacoesLibrary.ValidaTipoDecimal(txtPorcPerdMT.Text) && ValidacoesLibrary.ValidaTipoDecimal(TotalPerdaMT.Text) & ValidacoesLibrary.ValidaTipoDecimal(txtMT.Text))
                {
                    decimal TotalMT = Convert.ToDecimal(txtTotalMTLinear.Text);
                    decimal PorcPerda = Convert.ToDecimal(txtPorcPerdMT.Text);
                    decimal TotalPerda = Convert.ToDecimal(TotalPerdaMT.Text);
                    decimal TotalMTPerda = 0;

                    if (PorcPerda > 0)
                        TotalPerda = (TotalMT * PorcPerda) / 100;

                    TotalPerdaMT.Text = TotalPerda.ToString("n2");
                    TotalMTPerda = TotalPerda + TotalMT;

                    txtMT.Text = TotalMTPerda.ToString("n2");
                }
            }
            catch (Exception ex)
            {
        ...
        private void SomaUnitMTQ()
        {
            ...
            if (Convert.ToInt32(cbProdutoMTQ.SelectedValue) > 0)
            {
                ...
                if (PRODUTOSTyEn.MULTAREND > 0)
                {
                    ...
                    {
                        //Multiplo para Altura
                        decimal AlturaMTQ = 0;
                        AlturaMTQ = Convert.ToDecimal(txtAlturaMTQ.Text);

                        do
                        {
                            AlturaMTQ += Convert.ToDecimal("0,01");
                        }
                        while ((Convert.ToDecimal(AlturaMTQ) * 100) % PRODUTOSTyEn.MULTAREND != 0);


                        decimal LarguraMTQ = 0;
                        LarguraMTQ = Convert.ToDecimal(txtLarguraMTQ.Text) ;

                        //Multiplo para Largura
                        do
                        {
                            LarguraMTQ += Convert.ToDecimal("0,01");
                        }
                        while ((Convert.ToDecimal(LarguraMTQ) * 100) % PRODUTOSTyEn.MULTAREND != 0);


                        decimal TotalMTQ = AlturaMTQ * LarguraMTQ;
                        txtTotalMTQ.Text = TotalMTQ.ToString("n2");                      
                     
                    }
                    else
                    {
                        //decimal MULTAREND = (Convert.ToDecimal(PRODUTOSTyEn.MULTAREND) / 100);
                        decimal AlturaMTQ = 0;
                        //AlturaMTQ = Convert.ToDecimal(txtAlturaMTQ.Text) + MULTAREND;
                        AlturaMTQ = Convert.ToDecimal(txtAlturaMTQ.Text);

                        //Multiplo para Altura
                        //  if (AlturaMTQ % PRODUTOSTyEn.MULTAREND != 0)
                        do
                        {
                            AlturaMTQ += Convert.ToDecimal("1");
                        }
                        while ((Convert.ToDecimal(AlturaMTQ) * 100) % PRODUTOSTyEn.MULTAREND != 0);


                        decimal LarguraMTQ = 0;
                        //LarguraMTQ = Convert.ToDecimal(txtLarguraMTQ.Text) + MULTAREND;
                        LarguraMTQ = Convert.ToDecimal(txtLarguraMTQ.Text);

                        //Multiplo para Largura
                        // if (LarguraMTQ % PRODUTOSTyEn.MULTAREND != 0)
                        do
                        {
                            LarguraMTQ += Convert.ToDecimal("1");
                        }
                        while ((Convert.ToDecimal(LarguraMTQ) * 100) % PRODUTOSTyEn.MULTAREND != 0);
        ...
        private void SomaMultipoMtLinear()
        {
            PRODUTOSEntity PRODUTOSTyEn = new PRODUTOSEntity();
            ...
            {
                PRODUTOSTyEn = PRODUTOSP.Read(Convert.ToInt32(cbProduto.SelectedValue));
                ...
                if (PRODUTOSTyEn.MULTAREND > 0)
                {
                    if (PRODUTOSTyEn.FLAGDECIMALREND == "S")
                    {
                        ...
                        decimal AltLinear = 0;
                        AltLinear = Convert.ToDecimal(txtAltLinear.Text);

                        //Multiplo para Altura
                        do
                        {
                            AltLinear += Convert.ToDecimal("0,01");
                        }
                        while ((Convert.ToDecimal(AltLinear) * 100) % PRODUTOSTyEn.MULTAREND != 0);


                        decimal LargLinear = 0;
                        LargLinear = Convert.ToDecimal(txtLargLinear.Text);

                        //Multiplo para Largura
                        do
                        {
                            LargLinear += Convert.ToDecimal("0,01");
                        }
                        while ((Convert.ToDecimal(LargLinear) * 100) % PRODUTOSTyEn.MULTAREND != 0);


                        decimal TotalMTQ = Convert.ToDecimal(AltLinear) + Convert.ToDecimal(AltLinear) + Convert.ToDecimal(LargLinear) + Convert.ToDecimal(LargLinear);
                        if (BmsSoftware.ConfigSistema1.Default.FlagMetroLinear == "S")
                            TotalMTQ = Convert.ToDecimal(AltLinear) + Convert.ToDecimal(LargLinear);

                        txtTotalMTLinear.Text = TotalMTQ.ToString("n2");

                    }
                    else
                    {
                        decimal MULTAREND = Convert.ToDecimal(PRODUTOSTyEn.MULTAREND);
                        txtTotalMTLinear.Text = (Convert.ToDecimal(txtTotalMTLinear.Text) + MULTAREND).ToString();
                    }
                }
        ...
        private Boolean ValidacoesProdutosMTQ()
        {
            ...
            errorProvider1.Clear();
            if (Convert.ToInt32(cbProdutoMTQ.SelectedValue) < 1)
            {
            ...
            {
                if (Convert.ToDecimal(txtEstoqueMT2.Text) < (Convert.ToDecimal(txtTotalMTQ.Text) * Convert.ToDecimal(txtQuantMTQ.Text)))
                {
                    string Msgerro = "Estoque não pode ficar negativo!";
                    errorProvider1.SetError(txtTotalMTQ, Msgerro);
        ...
        private void SumTotalProdutosPedidoMTQ()
        {
            ...
            txtTotalProdMT2.Text = total.ToString("n2");
        ...
        private void SomaUnitMTLinear()
        {
            try
            {
                if (Convert.ToDecimal(txtAltLinear.Text) > 0)
                   // txtValorMtLinearTotal.Text = (((Convert.ToDecimal(txtTotalMTLinear.Text) + (Convert.ToDecimal(TotalPerdaMT)))* Convert.ToDecimal(txtValorUnitProd.Text)) * Convert.ToDecimal(txtQuanProduto.Text)).ToString("n2");
                    txtValorMtLinearTotal.Text = (((Convert.ToDecimal(txtMT.Text) * Convert.ToDecimal(txtValorUnitProd.Text)) * Convert.ToDecimal(txtQuanProduto.Text)).ToString("n2"));
                else
        ...
        private void txtAltLinear_Leave(object sender, EventArgs e)
        {
            try
            {
                txtTotalMTLinear.Text = (Convert.ToDecimal(txtAltLinear.Text) + Convert.ToDecimal(txtAltLinear.Text) + Convert.ToDecimal(txtLargLinear.Text) + Convert.ToDecimal(txtLargLinear.Text)).ToString("n" + CasasDecimais);
                if (BmsSoftware.ConfigSistema1.Default.FlagMetroLinear == "S")
                    txtTotalMTLinear.Text = (Convert.ToDecimal(txtAltLinear.Text) + Convert.ToDecimal(txtLargLinear.Text)).ToString("n" + CasasDecimais);
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Erro ao fazer cálculo!");
            }
        }
        ...
        {
            if (txtAltLinear.Text.Trim() == string.Empty)
                txtAltLinear.Text = "0,00";

            if (txtLargLinear.Text.Trim() == string.Empty)
                txtLargLinear.Text = "0,00";
        ...
        private void printDocument7_1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (CONFISISTEMAty.FLAGLOGORELATORIO == "S")
            {
                if (CONFISISTEMAty.IDARQUIVOBINARIO1 != null)
                {
                    ...
                    e.Graphics.DrawImage(System.Drawing.Image.FromStream(stream), config.MargemEsquerda + 530, 35, 180, 80);
            ...
            e.Graphics.DrawString(Util.LimiterText(config.NomeEmpresa, 50), config.FonteNegrito, Brushes.Black, config.MargemEsquerda + 30, 38);
            e.Graphics.DrawString(EMPRESATy.ENDERECO + " " + EMPRESATy.NUMERO, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 30, 53);
           // e.Graphics.DrawString(EMPRESATy.CIDADE + " " + EMPRESATy.UF, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 30, 68);
            //e.Graphics.DrawString(EMPRESATy.UF, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 320, 68);
           // e.Graphics.DrawString(EMPRESATy.TELEFONE + " Bairro: " + EMPRESATy.BAIRRO + " CEP: " + EMPRESATy.CEP, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 30, 83);
            ...
            if (EMPRESATy.BAIRRO.Trim() != string.Empty)
                e.Graphics.DrawString( "Bairro: " + EMPRESATy.BAIRRO + " CEP: " + EMPRESATy.CEP, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 30,  68);
            else
                e.Graphics.DrawString(" CEP: " + EMPRESATy.CEP, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 30, 68);

             e.Graphics.DrawString(EMPRESATy.CIDADE + " " + EMPRESATy.UF, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 30, 83);
             e.Graphics.DrawString(EMPRESATy.TELEFONE, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 30, 98);
            e.Graphics.DrawString(EMPRESATy.EMAIL, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 30, 113);
            
            
            if (CONFISISTEMAP.Read(1).FLAGCPFCNPJPEDIDO.TrimEnd() == "N" || CONFISISTEMAP.Read(1).FLAGCPFCNPJPEDIDO.TrimEnd() == string.Empty)
                e.Graphics.DrawString("CNPJ/CPF: " + EMPRESATy.CNPJCPF, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 200, 113);
            ...
            if (!chkDetalProdFinal.Checked)
            {
                for (; _line < LIS_PRODUTOSPEDIDOColl.Count; _line++)
                {
                    ...
                    if (chkTodoProdImpressao.Checked || LIS_PRODUTOSPEDIDOColl[_line].FLAGEXIBIR.ToUpper().TrimEnd() == "S" || LIS_PRODUTOSPEDIDOColl[_line].FLAGEXIBIR.TrimEnd() == string.Empty)
                    {
                        ...
                        e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : Convert.ToDecimal(LIS_PRODUTOSPEDIDOColl[_line].VALORUNITARIO).ToString("n4"), config.FonteConteudo, Brushes.Black, config.MargemEsquerda + 580, yLineTop + 80);
                        e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : Convert.ToDecimal(LIS_PRODUTOSPEDIDOColl[_line].VALORTOTAL).ToString("n2"), config.FonteConteudo, Brushes.Black, config.MargemEsquerda + 650, yLineTop + 80);
            ...
            if (LIS_PRODUTOSPEDIDOMTQColl.Count > 0)
            {
                ...
                if (chkItens1.Checked)
                    e.Graphics.DrawString("Item", config.FonteNegrito, Brushes.Black, config.MargemEsquerda - 30, yLineTop + 110);
             ...
             //   e.Graphics.DrawLine(config.CanetaDaImpressora, config.MargemEsquerda, yLineTop + 140, config.MargemDireita + 30, yLineTop + 140);
                ...
                for (; _line_1 < LIS_PRODUTOSPEDIDOMTQColl.Count; _line_1++)
                {
                    ...
                    if (chkTodoProdImpressao2.Checked || LIS_PRODUTOSPEDIDOMTQColl[_line_1].FLAGEXIBIR.ToUpper().TrimEnd() == "S" || LIS_PRODUTOSPEDIDOMTQColl[_line_1].FLAGEXIBIR.TrimEnd() == string.Empty)
                    {
                        ...
                        if (chkItens1.Checked)
                            e.Graphics.DrawString(itemproduto.ToString(), config.FonteNormal, Brushes.Black, config.MargemEsquerda - 20, yLineTop + 130);
                        ...
                        if (!chkValorMetro.Checked)
                            e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : Convert.ToDecimal(LIS_PRODUTOSPEDIDOMTQColl[_line_1].VALORUNITARIO).ToString("n2"), config.FonteConteudo, Brushes.Black, config.MargemEsquerda + 630, yLineTop + 145, stringFormat);
                        else

                            e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : Convert.ToDecimal(LIS_PRODUTOSPEDIDOMTQColl[_line_1].VALORMETRO).ToString("n2"), config.FonteConteudo, Brushes.Black, config.MargemEsquerda + 630, yLineTop + 145, stringFormat);


                        e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : Convert.ToDecimal(LIS_PRODUTOSPEDIDOMTQColl[_line_1].VALORTOTAL).ToString("n2"), config.FonteConteudo, Brushes.Black, config.MargemEsquerda + 730, yLineTop + 145, stringFormat);
          ...
          //  e.Graphics.DrawLine(config.CanetaDaImpressora, config.MargemEsquerda, config.MargemInferior, config.MargemDireita, config.MargemInferior);
            ...
            if (!chkvalortotal.Checked)
                e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : txtTotalProdAdicional.Text, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 730, yLineTop + linha, stringFormat);
            else
            ...
            if (!chkvalortotal.Checked)
                e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : txtTotalProdMTQ.Text, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 730, yLineTop + linha, stringFormat);
            else
                e.Graphics.DrawString("0,00", config.FonteNormal, Brushes.Black, config.MargemEsquerda + 730, yLineTop + linha, stringFormat);
            ...
            linha = linha + 15;
            if (!chkvalortotal.Checked)
                e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : txtPorcAcrescimo.Text + "% " + txtTotalAcrescimo.Text, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 730, yLineTop + linha, stringFormat);
            else
                e.Graphics.DrawString("0,00", config.FonteNormal, Brushes.Black, config.MargemEsquerda + 730, yLineTop + linha, stringFormat);
            ...
            if (chkvalortotal.Checked)
                ...
                e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : txtTotalPedido.Text, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 730, yLineTop + linha, stringFormat);

            e.Graphics.DrawString("Total Pago:", config.FonteNegrito, Brushes.Black, config.MargemEsquerda + 530, yLineTop + linha);
            linha = linha + 15;

            if (!chkvalortotal.Checked)
                e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : txtValorPago.Text, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 730, yLineTop + linha, stringFormat);
            else
                e.Graphics.DrawString("0,00", config.FonteNormal, Brushes.Black, config.MargemEsquerda + 730, yLineTop + linha, stringFormat);
            ...
            if (!chkvalortotal.Checked)
                e.Graphics.DrawString(chkNaoExibirValores.Checked ? "0,00" : txtValorDev.Text, config.FonteNormal, Brushes.Black, config.MargemEsquerda + 730, yLineTop + linha, stringFormat);
            else
                e.Graphics.DrawString("0,00", config.FonteNormal, Brushes.Black, config.MargemEsquerda + 730, yLineTop + linha, stringFormat);
        ...
        private void AddProdutoComposicaoProduto2(int IDPRODUTOMAIN)
        {
            ...
            foreach (LIS_PRODUTOCOMPOSICAOEntity item in LIS_PRODUTOCOMPOSICAOColl)
            {
                if (item.FLAGMETRO2.Trim() == "S")
                {
                    cbProdutoMTQ.SelectedValue = item.IDPRODUTO;
                    _IDPRODUTOMASTER = item.IDPRODUTO;
                    txtQuantMTQ.Text = Convert.ToDecimal(item.QUANTIDADE).ToString("n4");
                    txtAlturaMTQ.Text = Convert.ToDecimal(item.ALTURA).ToString("n4");
                    txtLarguraMTQ.Text = Convert.ToDecimal(item.LARGURA).ToString("n4");                  
                    ...
                    chkExibirProd2.Checked = item.FLAGEXIBIR.TrimEnd() == "N" ? true : false;
                    SomaPerdaMT2();
                    SomaUnitMTQ();
                ...
                else
                {
                    cbProduto.SelectedValue = item.IDPRODUTO;
                    txtQuanProduto.Text = Convert.ToDecimal(item.QUANTIDADE).ToString("n4");
                    txtAltLinear.Text = Convert.ToDecimal(item.ALTURA).ToString("n4");
                    txtLargLinear.Text = Convert.ToDecimal(item.LARGURA).ToString("n4");
                    SomaMultipoMtLinear();
        ...
        private void ImprimirReceitaReportSemValor()
        {
            using (FrmRelatPedidoVendaSemValor frm = new FrmRelatPedidoVendaSemValor())
            {
                frm.idcliente = Convert.ToInt32(cbCliente.SelectedValue);
                frm.NaoExibirValores = chkNaoExibirValores.Checked ? "true" : "false";
                frm.IDPEDIDO = _IDPEDIDO;
                frm.NaoExibirTotalMT2 = chkexibirTotalMt2.Checked ? "true" : "false";
                frm.NaoExibirImagemProduto = chkNaoExibirImagem.Checked ? "true" : "false";
                frm.ShowDialog();
        ...
        private void ImprimirReceitaReportGrupo()
        {
            ...
            {
                frm.ExibirApenasVlUnitario = !chkValorUnitario.Checked;
                frm.idcliente = Convert.ToInt32(cbCliente.SelectedValue);
                frm.NaoExibirValores = chkNaoExibirValores.Checked ? "true" : "false";
                frm.IDPEDIDO = _IDPEDIDO;
                frm.ShowDialog();
        ...
        private void txtVlTotalMTQ_Enter(object sender, EventArgs e)
        {
            SomaPerdaMT2();
        }

        private void txtvalorunitMTQ_Enter(object sender, EventArgs e)
        {
            SomaPerdaMT2();
        }

        private void txtvalorunitMTQ_Leave(object sender, EventArgs e)
        {
            SomaPerdaMT2();
        }

        private void txtVlMtrMTQ_Enter(object sender, EventArgs e)
        {
            SomaPerdaMT2();
        }

        private void txtVlMtrMTQ_Leave(object sender, EventArgs e)
        {
            SomaPerdaMT2();
        }

        private void txtPorcPerdMT_Validating(object sender, CancelEventArgs e)
        {
            TextBox TextBoxSelec = sender as TextBox;
            if (TextBoxSelec.Text != string.Empty)
            {
        ...
        private void TotalPerdaMT_TextChanged(object sender, EventArgs e)
        {
            TextBox TextBoxSelec = sender as TextBox;
            if (TextBoxSelec.Text != string.Empty)
            {
        ...
        private void txtPorcPerdMT_Leave(object sender, EventArgs e)
        {
            SomaPerdaMT();
        }

        private void TotalPerdaMT_Leave(object sender, EventArgs e)
        {
            SomaPerdaMT();
        }
        ...
        private void chkTelaBloqueada_CheckStateChanged(object sender, EventArgs e)
        {
           
        }

        private void composição2ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (_IDPEDIDO == -1)
            {
                MessageBox.Show("Antes de adicionar composições é necessário gravar o Pedido!",
            ...
            else
            {
                using (FrmSearchComposicao frm = new FrmSearchComposicao())
                {
                    ...
                    if (result > 0)
                    {
                        AddProdutoComposicaoMTLinear(result);
        ...
        private void composição2MTLinearToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void EnviarEmail()
        {
            try
            {
              ...
              //  var fromAddress = new MailAddress("contato@imexsistema.com.br", EMPRESATy.NOMECLIENTE + " " + EMPRESATy.EMAIL);
                ...
                body = "Caro(a) cliente " + CLIENTETy.NOME  + ", segue abaixo dados do seu Pedido/Orçamento <br>";              
                body += " " + "<br>"; 
                ...
                foreach (LIS_PRODUTOSPEDIDOMTQEntity item in LIS_PRODUTOSPEDIDOMTQColl)
                {
                    ...
                    html.Append("<td align=right >" + Convert.ToDecimal(item.MT2).ToString("n2") + "</td>");
        ...
        private void txtTipoPagamentoCartapCredito_Validating(object sender, CancelEventArgs e)
        {
            TextBox TextBoxSelec = sender as TextBox;
            if (TextBoxSelec.Text != string.Empty)
            {
        ...
        private void txtTotalMTLinear_Enter(object sender, EventArgs e)
        {
            SomaMultipoMtLinear();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            saveFileCsv.FileName = "DadosCSV.csv";
            string CsvFpath = saveFileCsv.FileName;
            System.IO.StreamWriter csvFileWriter = new System.IO.StreamWriter(CsvFpath, true);
            ...
            if (saveFileCsv.ShowDialog() == DialogResult.OK)
            {
                ...
                try
                {
                   ...
                   // int countColumn = DataGriewDados.ColumnCount - 1;
                    int countColumn = DataGriewDados.ColumnCount;

                    int iColCount = DataGriewDados.Columns.Count;
                    ...
                    //    dg.Cells[4].Value = "S";
                    //}
                    int ColunaSelecionad = 0;
                    foreach (DataGridViewRow dataRowObject in DataGriewDados.Rows)
                    {
                        ...
                        if (!dataRowObject.IsNewRow)
                        {
                            ...
                            {
                                string teste = dataRowObject.Cells[i].Value.ToString().Trim();
                                string Tipo = DataGriewDados.Columns[1].ValueType.FullName;
                                    
                                if (dataRowObject.Cells[i].Value != null || dataRowObject.Cells[i].Value.ToString().Trim() != string.Empty)
        ...
        private void txtTotalAcrescimo_Leave(object sender, EventArgs e)
        {
            txtPorComisVend_Validating(null, null);
        }
        ...
        private void desenhoProjetoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                string PastaOrigem = ConfigSistema1.Default.PathInstall;
                System.Diagnostics.Process Processo1 = System.Diagnostics.Process.Start(PastaOrigem + @"\DesenhoProjeto.exe");
            }
            catch (Exception ex)
            {
        ...
        private void txtAlturaMTQ_Enter(object sender, EventArgs e)
        {
            TextBox TextBoxSelec = sender as TextBox;
        ...
        private void txtLarguraMTQ_Enter(object sender, EventArgs e)
        {
            TextBox TextBoxSelec = sender as TextBox;
            if (TextBoxSelec.Text.Trim() != string.Empty && Convert.ToDecimal(TextBoxSelec.Text) == 0)
            {
        ...
        private void txtAltLinear_Enter(object sender, EventArgs e)
        {
            TextBox TextBoxSelec = sender as TextBox;
            if (TextBoxSelec.Text.Trim() != string.Empty && Convert.ToDecimal(TextBoxSelec.Text) == 0)
            {
        ...
        private void txtLargLinear_Enter(object sender, EventArgs e)
        {
            TextBox TextBoxSelec = sender as TextBox;
            if (TextBoxSelec.Text.Trim() != string.Empty && Convert.ToDecimal(TextBoxSelec.Text) == 0)
            {
        ...
        private void modelo5SemValoresToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (_IDPEDIDO == -1)
            {
                MessageBox.Show(ConfigMessage.Default.MsgSelecRegistro);
            ...
            if (LIS_PEDIDOColl.Count > 0 && rowindex > -1)
            {
                ...
                else if (ColumnSelecionada == 1)//Excluir
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        try
                        {
                            //Lista Arquivos do Pedido
                            ListaArquivoPedido(Convert.ToInt32(LIS_PEDIDOColl[rowindex].IDPEDIDO));  
                            //Lista Produtos do Pedido
                            ListaProdutoPedido(Convert.ToInt32(LIS_PEDIDOColl[rowindex].IDPEDIDO));      
                            ListaProdutoPedidoMTQ(Convert.ToInt32(LIS_PEDIDOColl[rowindex].IDPEDIDO));
                            //Lista Duplicatas do Pedido
                            GridDuplicatasPD(Convert.ToInt32(LIS_PEDIDOColl[rowindex].IDCLIENTE), LIS_PEDIDOColl[rowindex].IDPEDIDO.ToString().PadLeft(6, '0'));

                            //Excluir Arquivos do Pedido
                            foreach (var item in ARQUIVOPEDIDOColl)
                            {
                                ARQUIVOPEDIDOP.Delete(item.IDARQUIVOPEDIDO);
                            }
                            ...
                            try
                            {
                                ...
                                foreach (var item in LIS_PEDIDOColl)
                                {
                                    ...
                                    if (item.IDPEDIDO != null)
                                    {
                                        ...
                                        sw.WriteLine("P" + ";" + NumPedido + ";" + DataPedido + ";" + IDCliente + ";" + CPFVENDEDOR + ";" + IDFORMAPAGAMENTO + ";" + IDLOCALCOBRANCA + ";" + IDSTATUS + ";" + OBSERVACAO);

                                        //Dados do Produto MT2
                                        RowRelatorio.Clear();
                                        RowRelatorio.Add(new RowsFiltro("IDPEDIDO", "System.Int32", "=", item.IDPEDIDO.ToString()));
                                        LIS_PRODUTOSPEDIDOMTQCollection LIS_PRODUTOSPEDIDOMTQColl_Export = new LIS_PRODUTOSPEDIDOMTQCollection();
                                        LIS_PRODUTOSPEDIDOMTQColl_Export = LIS_PRODUTOSPEDIDOMTQP.ReadCollectionByParameter(RowRelatorio, "IDPRODUTO");

                                        int ContadorItens = 1;                                        
                                        foreach (var item_Produto in LIS_PRODUTOSPEDIDOMTQColl_Export)
                                        {
                                            ...
                                            string IDCOR = "000000";
                                            if (item_Produto.IDCOR != null)
                                                IDCOR = Convert.ToInt32(item_Produto.IDCOR).ToString().PadLeft(6, '0');

                                            string DADOSADICIONAIS = item_Produto.DADOADICIONAIS;

                                            string ALTURA = Convert.ToDecimal(item_Produto.ALTURA).ToString("n2").PadLeft(10, '0');
                                            string LARGURA = Convert.ToDecimal(item_Produto.LARGURA).ToString("n2").PadLeft(10, '0');

                                            string IDAMBIENTE = "000000";
                                            if (item_Produto.IDAMBIENTE != null)
                                                IDAMBIENTE = Convert.ToInt32(item_Produto.IDAMBIENTE).ToString().PadLeft(6, '0');

                                            //Grava Dados do produto do pedido
                                            sw.WriteLine("PMT2" + ";" + ContadorItens.ToString().PadLeft(6, '0') + ";" + NumPedido + ";" + CodProduto + ";" +
                                                        QuantProduto + ";" + PrecoUnitario + ";" + IDCOR + ";" + DADOSADICIONAIS + ";" +
                                                        ALTURA + ";" + LARGURA + ";" + IDAMBIENTE);


                                            ContadorItens++;
                                        }

                                        //Dados do Produto MT Linear
                                        RowRelatorio.Clear();
                                        RowRelatorio.Add(new RowsFiltro("IDPEDIDO", "System.Int32", "=", item.IDPEDIDO.ToString()));
                                        LIS_PRODUTOSPEDIDOCollection LIS_PRODUTOSPEDIDOColl_Export = new LIS_PRODUTOSPEDIDOCollection();
                                        LIS_PRODUTOSPEDIDOColl_Export = LIS_PRODUTOSPEDIDOP.ReadCollectionByParameter(RowRelatorio, "IDPRODUTO");

                                        ContadorItens = 1;
                                        foreach (var item_Produto in LIS_PRODUTOSPEDIDOColl_Export)
                                        {
                                            string CodProduto = Convert.ToInt32(item_Produto.IDPRODUTO).ToString().PadLeft(6, '0');
                                            string QuantProduto = Convert.ToDecimal(item_Produto.QUANTIDADE).ToString("n2").PadLeft(10, '0');
                                            string PrecoUnitario = Convert.ToDecimal(item_Produto.VALORUNITARIO).ToString("n2").PadLeft(10, '0');
                                            ...
                                            string DADOSADICIONAIS = item_Produto.DADOSADICIONAIS;
                                            ...
                                            //Grava Dados do produto do pedido
                                            sw.WriteLine("PMT" + ";" + ContadorItens.ToString().PadLeft(6, '0') + ";" + NumPedido + ";" + CodProduto + ";" +
                                                        QuantProduto + ";" + PrecoUnitario + ";" + IDCOR + ";" + DADOSADICIONAIS + ";" +
                                                        ALTURA + ";" + LARGURA + ";" + IDAMBIENTE);
            ...
            try
            {
                ...
                if (openFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    while ((linha = rd.ReadLine()) != null)
                    {
                        ...
                        else if (linhaseparada[0] == "PMT2") //Salva Produto MT2
                        {
                            decimal? TotalProduto = 0;

                            //Salva Dados do Produto
                            PRODUTOSPEDIDOMTQEntity PRODUTOSPEDIDOMTQTy_Import = new PRODUTOSPEDIDOMTQEntity();
                            PRODUTOSPEDIDOMTQTy_Import.IDPRODUTOSPEDIDOMTQ = -1;
                            PRODUTOSPEDIDOMTQTy_Import.IDPEDIDO = _IDPEDIDO;
                            PRODUTOSPEDIDOMTQTy_Import.IDPRODUTO = Convert.ToInt32(linhaseparada[3]);
                            PRODUTOSPEDIDOMTQTy_Import.QUANTIDADE = Convert.ToDecimal(linhaseparada[4]);
                            PRODUTOSPEDIDOMTQTy_Import.VALORUNITARIO = Convert.ToDecimal(linhaseparada[5]);
                            TotalProduto = Convert.ToDecimal(PRODUTOSPEDIDOMTQTy_Import.QUANTIDADE * PRODUTOSPEDIDOMTQTy_Import.VALORUNITARIO);
                            TotalGeral += TotalProduto;
                            PRODUTOSPEDIDOMTQTy_Import.VALORTOTAL = TotalProduto;

                            if (linhaseparada[6].Trim().ToString() != "000000")
                                PRODUTOSPEDIDOMTQTy_Import.IDCOR = Convert.ToInt32(linhaseparada[6].ToString());
                            else
                                PRODUTOSPEDIDOMTQTy_Import.IDCOR = null;

                            PRODUTOSPEDIDOMTQTy_Import.DADOADICIONAIS = linhaseparada[7].ToString();
                            PRODUTOSPEDIDOMTQTy_Import.ALTURA = Convert.ToDecimal(linhaseparada[8]);
                            PRODUTOSPEDIDOMTQTy_Import.LARGURA = Convert.ToDecimal(linhaseparada[9]);
                            PRODUTOSPEDIDOMTQTy_Import.MT2 = PRODUTOSPEDIDOMTQTy_Import.ALTURA * PRODUTOSPEDIDOMTQTy_Import.LARGURA;

                             if (linhaseparada[10].Trim().ToString() != "000000")
                                 PRODUTOSPEDIDOMTQTy_Import.IDAMBIENTE = Convert.ToInt32(linhaseparada[10].ToString());
                             else
                                 PRODUTOSPEDIDOMTQTy_Import.IDAMBIENTE = null;

                             PRODUTOSPEDIDOMTQTy_Import.FLAGEXIBIR = "S";

                             PRODUTOSPEDIDOMTQP.Save(PRODUTOSPEDIDOMTQTy_Import);
                        ...
                        else if (linhaseparada[0] == "PMT") ////Salva Produto MT
                        {
                            decimal? TotalProduto = 0;
                            ...
                            PRODUTOSPEDIDO_Import.IDPRODUTO = Convert.ToInt32(linhaseparada[3]);
                            PRODUTOSPEDIDO_Import.QUANTIDADE = Convert.ToDecimal(linhaseparada[4]);
                            PRODUTOSPEDIDO_Import.VALORUNITARIO = Convert.ToDecimal(linhaseparada[5]);
                            ...
                            if (linhaseparada[6].Trim().ToString() != "000000")
                                PRODUTOSPEDIDO_Import.IDCOR = Convert.ToInt32(linhaseparada[6].ToString());
                            else
                                PRODUTOSPEDIDO_Import.IDCOR = null;

                            PRODUTOSPEDIDO_Import.DADOSADICIONAIS = linhaseparada[7].ToString();
                            PRODUTOSPEDIDO_Import.ALTURA = Convert.ToDecimal(linhaseparada[8]);
                            PRODUTOSPEDIDO_Import.LARGURA = Convert.ToDecimal(linhaseparada[9]);
                            PRODUTOSPEDIDO_Import.TOTALMT = PRODUTOSPEDIDO_Import.ALTURA * PRODUTOSPEDIDO_Import.LARGURA;

                            if (linhaseparada[10].Trim().ToString() != "000000")
                                PRODUTOSPEDIDO_Import.IDAMBIENTE = Convert.ToInt32(linhaseparada[10].ToString());
                            else
                                PRODUTOSPEDIDO_Import.IDAMBIENTE = null;

                            PRODUTOSPEDIDO_Import.FLAGEXIBIR = "S";
        ...
        private void txtPesquisaRapida_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtPesquisaRapida_TextChanged(object sender, EventArgs e)
        {

        }

        private void chkExibirProd2_CheckedChanged(object sender, EventArgs e)
        {
