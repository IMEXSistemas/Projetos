...
{
    public partial class FrmComissaoporOS : Form
    {
        ...
        {
            string RelatorioTitulo = InputBox("Título do Relatório", ConfigSistema1.Default.NomeEmpresa, "Vendas por Vendedor - Ordem de Serviço");
        ...
        private void btnpdf_Click(object sender, EventArgs e)
        {
            ...
            {
                frm.TituloSelec = "Vendas por Vendedor - Ordem de Serviço";
