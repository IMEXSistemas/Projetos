...
{
    public partial class FrmRelatorioPConsignacao : Form
    {
        ...
        public LIS_CONSIGNACAOCollection LIS_CONSIGNACAOCollRelatPers = new LIS_CONSIGNACAOCollection();
        ...
        public FrmRelatorioPConsignacao()
        {
            InitializeComponent();
