...
{
    public partial class FrmControleEntregaMT2 : Form
    {
        ...
        private void cbProduto_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                txtQuantPedido.Text = LIS_PRODUTOSPEDIDOMTQColl[cbProduto.SelectedIndex].QUANTIDADE.ToString();
