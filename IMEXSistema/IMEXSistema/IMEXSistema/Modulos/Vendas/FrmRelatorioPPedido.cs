...
{
    public partial class FrmRelatorioPPedido : Form
    {
        ...
        public LIS_PEDIDOCollection LIS_PEDIDOCollRelatPers = new LIS_PEDIDOCollection();
        ...
        private void GetDropRelatorio()
        {
            ...
            RowsFiltro.Add(new RowsFiltro("IDTELA", "System.Int32", "=", "12"));
