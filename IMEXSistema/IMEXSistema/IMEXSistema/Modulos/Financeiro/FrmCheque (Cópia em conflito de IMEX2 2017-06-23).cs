...
namespace BmsSoftware.Modulos.Financeiro
{
    public partial class FrmCheque : Form
    {
        ...
        private Boolean Validacoes()
        {
            ...
            else if (Convert.ToDateTime(msktDataReceb.Text) < Convert.ToDateTime(msktDataEntrada.Text))
            {
                string Msgerro = "Data de recebimento menor que a data de entrada!";
                errorProvider1.SetError(msktDataReceb, Msgerro);
                errorProvider1.SetError(msktDataEntrada, Msgerro);
