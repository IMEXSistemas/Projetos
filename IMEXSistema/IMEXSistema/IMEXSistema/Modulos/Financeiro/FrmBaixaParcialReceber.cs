...
{
    public partial class FrmBaixaParcialReceber : Form
    {
      ...
      //  LIS_DUPLICATARECEBERCollection LIS_DUPLICATARECEBERColl = new LIS_DUPLICATARECEBERCollection();
        ...
        public MOVCONTACORRENTEEntity Entity
        {
            get
            {
                string NUMMOVIMENTACAOM = lblNDuplicata.Text;
                ...
                string OBSERVACAO = "Baixa parcial de duplicata a receber numero: " + lblNDuplicata.Text;
        ...
        private void BaixarParcial()
        {
            ...
            if (dr == DialogResult.Yes)
            {
                try
                {
                    ...
                    DUPLICATARECEBERTy.VALORDEVEDOR = Convert.ToDecimal(DUPLICATARECEBERTy.VALORDEVEDOR) - Convert.ToDecimal(txtValorPago.Text);

                    if (DUPLICATARECEBERTy.VALORDEVEDOR == 0)
                    ...
                    DUPLICATARECEBERTy.OBSERVACAO += "( Pago Parcial - Valor Pagto: " + txtValorPago.Text + " Data Pagto: " + msktDataPagto.Text + " ) ";
