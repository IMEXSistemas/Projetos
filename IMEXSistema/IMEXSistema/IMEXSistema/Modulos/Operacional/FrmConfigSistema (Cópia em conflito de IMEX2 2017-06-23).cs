...
namespace BmsSoftware.Modulos.Operacional
{
    public partial class FrmConfigSistema : Form
    {
        ...
        private void FrmConfigSistema_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (BmsSoftware.ConfigSistema1.Default.FlagControlaEstoque == "S")
                 ...
                 chkAdvogado.Checked = false;
                 if (BmsSoftware.ConfigSistema1.Default.FlagAdvogado == "S")
                     chkAdvogado.Checked = true;
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    try
                    {
                        ...
                        if (chkAdvogado.Checked)
                            BmsSoftware.ConfigSistema1.Default.FlagAdvogado = "S";
                        else
                            BmsSoftware.ConfigSistema1.Default.FlagAdvogado = "N";
        ...
        private void PreencherWebService()
        {
            try
            {
                EMPRESAEntity EMPRESATy = new EMPRESAEntity();            
