...
namespace BmsSoftware.Modulos.Cadastros
{
    public partial class FrmEstoqueMinimo : Form
    {
        ...
        {
            string RelatorioTitulo = InputBox("Estoque Atual", ConfigSistema1.Default.NomeEmpresa, "Estoque Mínimo");
        ...
        private void btnpdf_Click(object sender, EventArgs e)
        {
            ...
            {
                frm.TituloSelec = "Estoque Mínimo";
        ...
        {
            string RelatorioTitulo = InputBox("Título do Relatório", ConfigSistema1.Default.NomeEmpresa, "Estoque Mínimo");
            PrintDGV PRt = new PrintDGV();
            PRt.Print_DataGridView(DataGriewDados, RelatorioTitulo, this.Name);
        }
    }
