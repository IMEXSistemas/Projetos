...
{
    public partial class FrmLocalCobranca : Form
    {
        ...
        public int _IDLOCALCOBRANCA = -1;
        public LOCALCOBRANCAEntity Entity
        {
            get
            {
                string CODIGOCOBRANCA = txtCodigo.Text;
                string NOME = txtNome.Text;
                string OBSERVACAO = txtObservacao.Text;
                return new LOCALCOBRANCAEntity(_IDLOCALCOBRANCA, CODIGOCOBRANCA, NOME, OBSERVACAO);
            }
            set
            {
                ...
                if (value != null)
                {
                    _IDLOCALCOBRANCA = value.IDLOCALCOBRANCA;
                    txtCodigo.Text = value.CODIGOCOBRANCA;
        ...
        private void Grava()
        {
            try
            {
                if (Validacoes())
                {
                    _IDLOCALCOBRANCA = LOCALCOBRANCAP.Save(Entity);
                    GetAllLocalCobranca();
        ...
        private void GetAllLocalCobranca()
        {
            ...
            DataGriewDados.DataSource = LOCALCOBRANCAColl;

            lblTotalPesquisa.Text = LOCALCOBRANCAColl.Count.ToString();
        }
        ...
        private Boolean Validacoes()
        {
            ...
            {
                errorProvider1.SetError(txtCodigo, ConfigMessage.Default.CampoObrigatorio);
