...
{
    public partial class FrmSearchClienteTelefone : Form
    {
        ...
        public FrmSearchClienteTelefone()
        {
            InitializeComponent();
        ...
        private void PesquisaCliente()
        {
            try
            {
                if (txtNomePesquisa.Text.Trim() != string.Empty)
                {
                    ...
                    RowRelatorio.Add(new RowsFiltro("FAX", "System.String", "collate pt_br like", "%" + txtNomePesquisa.Text.Replace("'", "") + "%"));
