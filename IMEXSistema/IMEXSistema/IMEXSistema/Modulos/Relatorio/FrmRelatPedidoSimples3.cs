...
{
    public partial class FrmRelatPedidoSimples3 : Form
    {
        ...
        private void FrmPedidoSimples_Load(object sender, EventArgs e)
        {
            ...
            //p[3] = new Microsoft.Reporting.WinForms.ReportParameter("nomeempresa", EMPRESAColl[0].NOMEFANTASIA);
            //p[4] = new Microsoft.Reporting.WinForms.ReportParameter("VisualizaProduto1", "true");
            //p[5] = new Microsoft.Reporting.WinForms.ReportParameter("VisualizaProduto2", "true");
            //p[6] = new Microsoft.Reporting.WinForms.ReportParameter("NaoExibirValores", "true");
