...
{
    public partial class FrmRelatOrdemServico3 : Form
    {
        ...
        private void FrmRelatPedidoVendas_Load(object sender, EventArgs e)
        {
            ...
            p[6] = new Microsoft.Reporting.WinForms.ReportParameter("PLACA", PLACA);
            p[7] = new Microsoft.Reporting.WinForms.ReportParameter("ListaEquipamento", ListaEquipamento);
            p[8] = new Microsoft.Reporting.WinForms.ReportParameter("MARCAMODELO", MARCAMODELO);
