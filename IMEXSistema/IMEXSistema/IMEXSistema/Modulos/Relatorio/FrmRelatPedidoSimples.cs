...
{
    public partial class FrmRelatPedidoSimples : Form
    {
        ...
        private void FrmPedidoSimples_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                LIS_CLIENTEColl[0].NOME = LIS_CLIENTEColl[0].NOME + " - " + LIS_CLIENTEColl[0].IDCLIENTE.ToString();
                ...
                if (BmsSoftware.ConfigSistema1.Default.FlagOrdenarProdutoPedido.Trim() == "S")
