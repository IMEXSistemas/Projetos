...
{
    public partial class FrmRelatContrato2 : Form
    {
        public CONTRATOCollection CONTRATOColl = new CONTRATOCollection();
        RowsFiltroCollection RowRelatorio = new RowsFiltroCollection();   

        public FrmRelatContrato2()
        {
            InitializeComponent();
        }

        private void FrmRelatContrato2_Load(object sender, EventArgs e)
        {
            ...
            this.CONTRATOCollectionBindingSource.DataSource = CONTRATOColl;
