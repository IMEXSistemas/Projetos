...
{
    public partial class EMPRESAASPNETUSERSIMEXAPPProvider
    {
        ...
        public async void Save(EMPRESAASPNETUSERSIMEXAPPEntity Entity)
        {
            try
            {
        ...
        public int GetID(int CodRegistro)
        {
            ...
            try
            {
                ...
                CONFISISTEMATy = CONFISISTEMAP.Read(1);
                string token = CONFISISTEMATy.TOKENIMEXAPP.Trim();
                string URI = BmsSoftware.Modulos.IMEXApp.UrlIMEXApp.Default.GetRegistroRepresentante;
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    EMPRESAASPNETUSERSIMEXAPPColl = DeserializeToList<EMPRESAASPNETUSERSIMEXAPPEntity>(jsonString);
                }
        ...
        public IList<EMPRESAASPNETUSERSIMEXAPPEntity> GetID()
        {
            ...
            try
            {
                ...
                return EMPRESAASPNETUSERSIMEXAPPColl;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Erro Técnico: " + ex.Message);
        ...
        public int BuscaID(int IDRegistro)
        {
            ...
            try
            {
                foreach (var item in EMPRESAASPNETUSERSIMEXAPPColl)
                {
                    ...
                    {
                        result = Convert.ToInt32(item.IDEMPRESAASPNETUSERS);
                        break;
                    }
                }
