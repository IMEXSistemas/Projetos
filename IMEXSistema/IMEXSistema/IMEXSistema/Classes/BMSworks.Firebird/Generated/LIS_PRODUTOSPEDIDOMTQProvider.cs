...
{
	public partial class LIS_PRODUTOSPEDIDOMTQProvider 
	{
		...
		public  LIS_PRODUTOSPEDIDOMTQCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_PRODUTOSPEDIDOMTQCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_PRODUTOSPEDIDOMTQ", dbCnn);
		...
		public  LIS_PRODUTOSPEDIDOMTQCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDIDOMTQ WHERE (";
...
public  LIS_PRODUTOSPEDIDOMTQCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDIDOMTQ WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDIDOMTQ  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_PRODUTOSPEDIDOMTQCollection ExecuteReader(ref LIS_PRODUTOSPEDIDOMTQCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_PRODUTOSPEDIDOMTQCollection();
