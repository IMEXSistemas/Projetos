...
{
	public partial class LIS_FECHOSERVICOProvider 
	{
		...
		public  LIS_FECHOSERVICOCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_FECHOSERVICOCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_FECHOSERVICO", dbCnn);
		...
		public  LIS_FECHOSERVICOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_FECHOSERVICO WHERE (";
...
public  LIS_FECHOSERVICOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_FECHOSERVICO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_FECHOSERVICO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_FECHOSERVICOCollection ExecuteReader(ref LIS_FECHOSERVICOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_FECHOSERVICOCollection();
		...
		private static LIS_FECHOSERVICOEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_FECHOSERVICOEntity entity = new LIS_FECHOSERVICOEntity();
