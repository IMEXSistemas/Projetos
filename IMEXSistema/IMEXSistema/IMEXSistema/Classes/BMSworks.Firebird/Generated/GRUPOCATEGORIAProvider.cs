...
{
	public partial class GRUPOCATEGORIAProvider
	{
...
dbCommand.Parameters.AddWithValue("@OBSERVACAO", Entity.OBSERVACAO); //Coluna 
		...
		public  int Save(int? IDGRUPOGATEGORIA, string NOME, string OBSERVACAO)
		{	
			int result = 0;
...
dbCommand.Parameters.AddWithValue("@OBSERVACAO", OBSERVACAO); //Coluna 
				...
				dbCommand.Parameters["@IDGRUPOGATEGORIA"].Direction = ParameterDirection.ReturnValue;
				
				//Executando consulta
				dbCommand.ExecuteNonQuery();
							
			    result = (int)(dbCommand.Parameters["@IDGRUPOGATEGORIA"].Value);
		...
		public  int Delete(int IDGRUPOGATEGORIA)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_GRUPOCATEGORIA", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  GRUPOCATEGORIACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			GRUPOCATEGORIACollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM GRUPOCATEGORIA WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM GRUPOCATEGORIA  ";
					}
				}
				else
				{
		...
		public  GRUPOCATEGORIACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			GRUPOCATEGORIACollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM GRUPOCATEGORIA  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static GRUPOCATEGORIACollection ExecuteReader(ref GRUPOCATEGORIACollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new GRUPOCATEGORIACollection();
