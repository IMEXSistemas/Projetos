...
{
	public partial class LIS_CAIXAProvider 
	{
		...
		public  LIS_CAIXACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_CAIXA WHERE (";
...
public  LIS_CAIXACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_CAIXAEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_CAIXAEntity entity = new LIS_CAIXAEntity();
