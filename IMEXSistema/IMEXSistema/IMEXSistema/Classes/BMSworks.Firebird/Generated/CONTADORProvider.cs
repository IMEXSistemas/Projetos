...
{
	public partial class CONTADORProvider
	{
		...
		public  int Save(CONTADOREntity Entity )
		{	
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Sav_CONTADOR", dbCnn);
				...
				if (Entity.CONTADORID == -1)
					dbCommand.Parameters.AddWithValue("@CONTADORID", DBNull.Value);
				else
					dbCommand.Parameters.AddWithValue("@CONTADORID", Entity.CONTADORID);
					...
					dbCommand.Parameters.AddWithValue("@CRC", Entity.CRC); //Coluna 
					...
					dbCommand.Parameters.AddWithValue("@FONE", Entity.FONE); //Coluna 
					dbCommand.Parameters.AddWithValue("@FAX", Entity.FAX); //Coluna 
					dbCommand.Parameters.AddWithValue("@EMAIL", Entity.EMAIL); //Coluna 
					
					if(Entity.COD_MUN!= null)
						dbCommand.Parameters.AddWithValue("@COD_MUN", Entity.COD_MUN); //ForeignKey 
					else
						dbCommand.Parameters.AddWithValue("@COD_MUN", DBNull.Value); //ForeignKey 5
				...
				dbCommand.Parameters["@CONTADORID"].Direction = ParameterDirection.InputOutput;

				
				//Executando consulta
				dbCommand.ExecuteNonQuery();
							
			    result = int.Parse(dbCommand.Parameters["@CONTADORID"].Value.ToString());
        ...
        public int Save(int? CONTADORID, string NOME, string CPF, string CNPJ, string CRC, string CEP, string ENDERECO, string NUMERO, string COMPLEMENTO, string BAIRRO, string FONE, string FAX, string EMAIL, int COD_MUN, string OBSERVACAO)
		{	
			int result = 0;
			...
			try
			{
				...
				dbCommand.CommandType = CommandType.StoredProcedure;
									...
									if (CONTADORID == -1)
										...
										dbCommand.Parameters.AddWithValue("@CONTADORID", CONTADORID);
										...
										dbCommand.Parameters.AddWithValue("@CRC", CRC); //Coluna 
										...
										dbCommand.Parameters.AddWithValue("@FONE", FONE); //Coluna 
										dbCommand.Parameters.AddWithValue("@FAX", FAX); //Coluna 
										dbCommand.Parameters.AddWithValue("@EMAIL", EMAIL); //Coluna 
										
										if(COD_MUN!= null)
											dbCommand.Parameters.AddWithValue("@COD_MUN", COD_MUN); //ForeignKey 
										else
											dbCommand.Parameters.AddWithValue("@COD_MUN", DBNull.Value); //ForeignKey 5
		...
		public  int Delete(int CONTADORID)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_CONTADOR", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				dbCommand.Parameters.AddWithValue("@CONTADORID",CONTADORID); //PrimaryKey
		...
		public  CONTADOREntity Read(int CONTADORID)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_CONTADOR", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  CONTADORCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			CONTADORCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM CONTADOR WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM CONTADOR  ";
					}
				}
				else
				{
		...
		public  CONTADORCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			CONTADORCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM CONTADOR  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static CONTADORCollection ExecuteReader(ref CONTADORCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new CONTADORCollection();
		...
		private static CONTADOREntity FillEntityObject(ref FbDataReader DataReader) 
		{
			CONTADOREntity entity = new CONTADOREntity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

							entity.CONTADORID = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("CONTADORID"));
			...
			entity.CRC = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("CRC"));
			...
			entity.FONE = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("FONE"));
			...
			entity.COD_MUN = getData.ConvertDBValueToInt32Nullable(DataReader, DataReader.GetOrdinal("COD_MUN"));
