...
{
	public partial class LIS_ORCAMENTOProvider 
	{
		...
		public  LIS_ORCAMENTOCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_ORCAMENTOCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_ORCAMENTO", dbCnn);
		...
		public  LIS_ORCAMENTOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_ORCAMENTO WHERE (";
...
public  LIS_ORCAMENTOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_ORCAMENTO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_ORCAMENTO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_ORCAMENTOCollection ExecuteReader(ref LIS_ORCAMENTOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_ORCAMENTOCollection();
		...
		private static LIS_ORCAMENTOEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_ORCAMENTOEntity entity = new LIS_ORCAMENTOEntity();
			...
			entity.NOMETRANSPORTE = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMETRANSPORTE"));
