...
{
	public partial class PRODUTOSPEDIDOMTQOSProvider
	{
		...
		public  int Save(PRODUTOSPEDIDOMTQOSEntity Entity )
		{	
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Sav_PRODUTOSPEDIDOMTQOS", dbCnn);
				...
				if (Entity.IDPRODUTOSPEDIDOMTQOS == -1)
					dbCommand.Parameters.AddWithValue("@IDPRODUTOSPEDIDOMTQOS", DBNull.Value);
				else
					dbCommand.Parameters.AddWithValue("@IDPRODUTOSPEDIDOMTQOS", Entity.IDPRODUTOSPEDIDOMTQOS);
				...
				dbCommand.Parameters["@IDPRODUTOSPEDIDOMTQOS"].Direction = ParameterDirection.InputOutput;

				
				//Executando consulta
				dbCommand.ExecuteNonQuery();
							
			    result = int.Parse(dbCommand.Parameters["@IDPRODUTOSPEDIDOMTQOS"].Value.ToString());
		...
		public  int Save(int? IDPRODUTOSPEDIDOMTQOS, int IDORDEMSERVICO, int IDPRODUTO, decimal QUANTIDADE, decimal ALTURA, decimal LARGURA, decimal MT2, decimal VALORMETRO, decimal VALORUNITARIO, decimal VALORTOTAL, decimal COMISSAO, decimal PORCPERDAMT, decimal TOTALPERDAMT)
		{	
			int result = 0;
			...
			try
			{
				...
				dbCommand.CommandType = CommandType.StoredProcedure;
									...
									//PrimaryKey com valor igual a null, indica um novo registro, 
									//o valor da chave será fornecido pelo banco. Qualquer outro valor indicará edição do registro.
									if (IDPRODUTOSPEDIDOMTQOS == -1)
										dbCommand.Parameters.AddWithValue("@IDPRODUTOSPEDIDOMTQOS", DBNull.Value);
									else
										dbCommand.Parameters.AddWithValue("@IDPRODUTOSPEDIDOMTQOS", IDPRODUTOSPEDIDOMTQOS);
		...
		public  int Delete(int IDPRODUTOSPEDIDOMTQOS)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_PRODUTOSPEDIDOMTQOS", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				dbCommand.Parameters.AddWithValue("@IDPRODUTOSPEDIDOMTQOS",IDPRODUTOSPEDIDOMTQOS); //PrimaryKey
		...
		public  PRODUTOSPEDIDOMTQOSEntity Read(int IDPRODUTOSPEDIDOMTQOS)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_PRODUTOSPEDIDOMTQOS", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				PRODUTOSPEDIDOMTQOSEntity entity = null;
				if (reader.HasRows)
				{
					while (reader.Read())
					{
		...
		public  PRODUTOSPEDIDOMTQOSCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			PRODUTOSPEDIDOMTQOSCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTOSPEDIDOMTQOS WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTOSPEDIDOMTQOS  ";
					}
				}
				else
				{
		...
		public  PRODUTOSPEDIDOMTQOSCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			PRODUTOSPEDIDOMTQOSCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTOSPEDIDOMTQOS  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static PRODUTOSPEDIDOMTQOSCollection ExecuteReader(ref PRODUTOSPEDIDOMTQOSCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new PRODUTOSPEDIDOMTQOSCollection();
		...
		private static PRODUTOSPEDIDOMTQOSEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			PRODUTOSPEDIDOMTQOSEntity entity = new PRODUTOSPEDIDOMTQOSEntity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

							entity.IDPRODUTOSPEDIDOMTQOS = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDPRODUTOSPEDIDOMTQOS"));
