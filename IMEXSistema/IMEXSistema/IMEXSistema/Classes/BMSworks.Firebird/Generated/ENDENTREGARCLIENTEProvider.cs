...
{
	public partial class ENDENTREGARCLIENTEProvider
	{
		...
		public  int Save(int? IDENDENTREGARCLIENTE, int IDCLIENTE, string NOME, string ENDERECO, string NUMERO, string COMPLEMENTO, string BAIRRO, string CEP, string CIDADE, string UF)
		{	
			int result = 0;
			...
			try
			{
				...
				dbCommand.CommandType = CommandType.StoredProcedure;
									...
									//PrimaryKey com valor igual a null, indica um novo registro, 
									//o valor da chave será fornecido pelo banco. Qualquer outro valor indicará edição do registro.
									if (IDENDENTREGARCLIENTE == -1)
										dbCommand.Parameters.AddWithValue("@IDENDENTREGARCLIENTE", DBNull.Value);
									else
										dbCommand.Parameters.AddWithValue("@IDENDENTREGARCLIENTE", IDENDENTREGARCLIENTE);
		...
		public  int Delete(int IDENDENTREGARCLIENTE)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_ENDENTREGARCLIENTE", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				dbCommand.Parameters.AddWithValue("@IDENDENTREGARCLIENTE",IDENDENTREGARCLIENTE); //PrimaryKey
		...
		public  ENDENTREGARCLIENTEEntity Read(int IDENDENTREGARCLIENTE)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_ENDENTREGARCLIENTE", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				ENDENTREGARCLIENTEEntity entity = null;
				if (reader.HasRows)
				{
					while (reader.Read())
					{
		...
		public  ENDENTREGARCLIENTECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			ENDENTREGARCLIENTECollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM ENDENTREGARCLIENTE WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM ENDENTREGARCLIENTE  ";
					}
				}
				else
				{
		...
		public  ENDENTREGARCLIENTECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			ENDENTREGARCLIENTECollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM ENDENTREGARCLIENTE  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static ENDENTREGARCLIENTECollection ExecuteReader(ref ENDENTREGARCLIENTECollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new ENDENTREGARCLIENTECollection();
		...
		private static ENDENTREGARCLIENTEEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			ENDENTREGARCLIENTEEntity entity = new ENDENTREGARCLIENTEEntity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

							entity.IDENDENTREGARCLIENTE = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDENDENTREGARCLIENTE"));
