...
{
	public partial class LIS_MOVPRODUTOES2Provider 
	{
		...
		public  LIS_MOVPRODUTOES2Collection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_MOVPRODUTOES2Collection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_MOVPRODUTOES2", dbCnn);
		...
		public  LIS_MOVPRODUTOES2Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_MOVPRODUTOES2 WHERE (";
...
public  LIS_MOVPRODUTOES2Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_MOVPRODUTOES2 WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_MOVPRODUTOES2  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_MOVPRODUTOES2Collection ExecuteReader(ref LIS_MOVPRODUTOES2Collection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_MOVPRODUTOES2Collection();
		...
		private static LIS_MOVPRODUTOES2Entity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_MOVPRODUTOES2Entity entity = new LIS_MOVPRODUTOES2Entity();
			...
			entity.DATAMOVIMENTACAO = getData.ConvertDBValueToDateTime(DataReader, DataReader.GetOrdinal("DATAMOVIMENTACAO"));
