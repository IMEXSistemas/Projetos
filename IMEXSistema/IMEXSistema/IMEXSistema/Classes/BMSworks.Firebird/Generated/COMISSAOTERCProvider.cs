...
{
	public partial class COMISSAOTERCProvider
	{
		...
		public  int Save(int? IDCOMISSAOTERC, int IDPEDIDO, int IDFUNCIONARIO, decimal PORCENTAGEM, decimal VALOR)
		{	
			int result = 0;
			...
			try
			{
				...
				dbCommand.CommandType = CommandType.StoredProcedure;
									...
									if (IDCOMISSAOTERC == -1)
										...
										dbCommand.Parameters.AddWithValue("@IDCOMISSAOTERC", IDCOMISSAOTERC);
										...
										dbCommand.Parameters.AddWithValue("@PORCENTAGEM", PORCENTAGEM); //Coluna 
		...
		public  int Delete(int IDCOMISSAOTERC)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_COMISSAOTERC", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  COMISSAOTERCCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			COMISSAOTERCCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM COMISSAOTERC WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM COMISSAOTERC  ";
					}
				}
				else
				{
		...
		public  COMISSAOTERCCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			COMISSAOTERCCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM COMISSAOTERC  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static COMISSAOTERCCollection ExecuteReader(ref COMISSAOTERCCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new COMISSAOTERCCollection();
