...
{
	public partial class LIS_CHEQUEProvider 
	{
		...
		public  LIS_CHEQUECollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_CHEQUECollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_CHEQUE", dbCnn);
		...
		public  LIS_CHEQUECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_CHEQUE WHERE (";
...
public  LIS_CHEQUECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_CHEQUE WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_CHEQUE  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_CHEQUECollection ExecuteReader(ref LIS_CHEQUECollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_CHEQUECollection();
		...
		private static LIS_CHEQUEEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_CHEQUEEntity entity = new LIS_CHEQUEEntity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

						entity.IDCHEQUE = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDCHEQUE"));
			...
			entity.ENTRADA = getData.ConvertDBValueToDateTimeNullable(DataReader, DataReader.GetOrdinal("ENTRADA"));
			entity.BOMPARA = getData.ConvertDBValueToDateTimeNullable(DataReader, DataReader.GetOrdinal("BOMPARA"));
			...
			entity.NOMEFUNC = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMEFUNC"));
			entity.TIPORECEBIMENTO = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("TIPORECEBIMENTO"));
			entity.NOMECLIENTEFORNEC = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMECLIENTEFORNEC"));
			...
			entity.TITULAR = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("TITULAR"));
