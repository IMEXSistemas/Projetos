...
{
	public partial class LIS_PRODUTOSPEDFESTAProvider 
	{
		...
		public  LIS_PRODUTOSPEDFESTACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDFESTA WHERE (";
...
public  LIS_PRODUTOSPEDFESTACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_PRODUTOSPEDFESTAEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTOSPEDFESTAEntity entity = new LIS_PRODUTOSPEDFESTAEntity();
			...
			entity.IDPRODUTOS = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDPRODUTOS"));
