...
{
	public partial class LIS_FORNECEDORProvider 
	{
		...
		public  LIS_FORNECEDORCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_FORNECEDORCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_FORNECEDOR", dbCnn);
		...
		public  LIS_FORNECEDORCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = " SELECT * FROM LIS_FORNECEDOR WHERE (";
...
public  LIS_FORNECEDORCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
		...
		private static LIS_FORNECEDORCollection ExecuteReader(ref LIS_FORNECEDORCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_FORNECEDORCollection();
		...
		private static LIS_FORNECEDOREntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_FORNECEDOREntity entity = new LIS_FORNECEDOREntity();
