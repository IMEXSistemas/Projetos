...
{
	public partial class LIS_DUPLICATAPAGARProvider 
	{
		...
		public  LIS_DUPLICATAPAGARCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_DUPLICATAPAGARCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_DUPLICATAPAGAR", dbCnn);
		...
		public  LIS_DUPLICATAPAGARCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_DUPLICATAPAGAR WHERE (";
...
public  LIS_DUPLICATAPAGARCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_DUPLICATAPAGAR WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_DUPLICATAPAGAR  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_DUPLICATAPAGARCollection ExecuteReader(ref LIS_DUPLICATAPAGARCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_DUPLICATAPAGARCollection();
		...
		private static LIS_DUPLICATAPAGAREntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_DUPLICATAPAGAREntity entity = new LIS_DUPLICATAPAGAREntity();
			...
			entity.NOMECENTROCUSTO = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMECENTROCUSTO"));
			...
			entity.NOMETIPODUPLICATA = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMETIPODUPLICATA"));
			...
			entity.DIASATRASO = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("DIASATRASO"));
