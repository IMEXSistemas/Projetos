...
{
	public partial class LIS_PRODUTOSESTMINIProvider 
	{
		...
		public  LIS_PRODUTOSESTMINICollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_PRODUTOSESTMINICollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_PRODUTOSESTMINI", dbCnn);
		...
		public  LIS_PRODUTOSESTMINICollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTOSESTMINI WHERE (";
...
public  LIS_PRODUTOSESTMINICollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_PRODUTOSESTMINI WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_PRODUTOSESTMINI  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_PRODUTOSESTMINICollection ExecuteReader(ref LIS_PRODUTOSESTMINICollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_PRODUTOSESTMINICollection();
		...
		private static LIS_PRODUTOSESTMINIEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTOSESTMINIEntity entity = new LIS_PRODUTOSESTMINIEntity();
