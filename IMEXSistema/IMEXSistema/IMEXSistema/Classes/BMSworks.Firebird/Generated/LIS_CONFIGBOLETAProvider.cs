...
{
	public partial class LIS_CONFIGBOLETAProvider 
	{
		...
		public  LIS_CONFIGBOLETACollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_CONFIGBOLETACollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_CONFIGBOLETA", dbCnn);
		...
		public  LIS_CONFIGBOLETACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_CONFIGBOLETA WHERE (";
...
public  LIS_CONFIGBOLETACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_CONFIGBOLETA WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_CONFIGBOLETA  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_CONFIGBOLETACollection ExecuteReader(ref LIS_CONFIGBOLETACollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_CONFIGBOLETACollection();
		...
		private static LIS_CONFIGBOLETAEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_CONFIGBOLETAEntity entity = new LIS_CONFIGBOLETAEntity();
			...
			entity.CODCEDENTE = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("CODCEDENTE"));
