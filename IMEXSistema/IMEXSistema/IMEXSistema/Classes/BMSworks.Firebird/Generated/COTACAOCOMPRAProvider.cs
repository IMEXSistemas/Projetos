...
{
	public partial class COTACAOCOMPRAProvider
	{
		...
		public  int Save(COTACAOCOMPRAEntity Entity )
		{	
			int result = 0;
			...
			try
			{
				...
				if (Entity.IDCOTACAOCOMPRA == -1)
					dbCommand.Parameters.AddWithValue("@IDCOTACAOCOMPRA", DBNull.Value);
				else
					dbCommand.Parameters.AddWithValue("@IDCOTACAOCOMPRA", Entity.IDCOTACAOCOMPRA);
					...
					dbCommand.Parameters.AddWithValue("@FLAGCOTACAO", Entity.FLAGCOTACAO); //Coluna 
					...
					dbCommand.Parameters.AddWithValue("@TOTALCOTACAO", Entity.TOTALCOTACAO); //Coluna 
		...
		public  int Delete(int IDCOTACAOCOMPRA)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_COTACAOCOMPRA", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				dbCommand.Parameters.AddWithValue("@IDCOTACAOCOMPRA",IDCOTACAOCOMPRA); //PrimaryKey
		...
		public  COTACAOCOMPRAEntity Read(int IDCOTACAOCOMPRA)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_COTACAOCOMPRA", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				COTACAOCOMPRAEntity entity = null;
				if (reader.HasRows)
				{
					while (reader.Read())
					{
		...
		public  COTACAOCOMPRACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			COTACAOCOMPRACollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM COTACAOCOMPRA WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM COTACAOCOMPRA  ";
					}
				}
				else
				{
		...
		public  COTACAOCOMPRACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			COTACAOCOMPRACollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM COTACAOCOMPRA  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static COTACAOCOMPRACollection ExecuteReader(ref COTACAOCOMPRACollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new COTACAOCOMPRACollection();
		...
		private static COTACAOCOMPRAEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			COTACAOCOMPRAEntity entity = new COTACAOCOMPRAEntity();
			...
			entity.FLAGCOTACAO = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("FLAGCOTACAO"));
			...
			entity.TOTALCOTACAO = getData.ConvertDBValueToDecimalNullable(DataReader, DataReader.GetOrdinal("TOTALCOTACAO"));
