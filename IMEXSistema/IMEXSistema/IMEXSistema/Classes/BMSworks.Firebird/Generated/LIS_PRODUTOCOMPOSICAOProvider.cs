...
{
	public partial class LIS_PRODUTOCOMPOSICAOProvider 
	{
		...
		public  LIS_PRODUTOCOMPOSICAOCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_PRODUTOCOMPOSICAOCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_PRODUTOCOMPOSICAO", dbCnn);
		...
		public  LIS_PRODUTOCOMPOSICAOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTOCOMPOSICAO WHERE (";
...
public  LIS_PRODUTOCOMPOSICAOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_PRODUTOCOMPOSICAO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_PRODUTOCOMPOSICAO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_PRODUTOCOMPOSICAOCollection ExecuteReader(ref LIS_PRODUTOCOMPOSICAOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_PRODUTOCOMPOSICAOCollection();
		...
		private static LIS_PRODUTOCOMPOSICAOEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTOCOMPOSICAOEntity entity = new LIS_PRODUTOCOMPOSICAOEntity();
			...
			entity.IDPRODUTOMAIN = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDPRODUTOMAIN"));
