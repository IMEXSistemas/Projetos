...
{
	public partial class MEDICOProvider
	{
...
if(IDMEDICO!= -1)
	dbCommand.Parameters.AddWithValue("@IDMEDICO", IDMEDICO); //PrimaryKey 
else
	dbCommand.Parameters.AddWithValue("@IDMEDICO", DBNull.Value); //PrimaryKey 
...
dbCommand.Parameters.AddWithValue("@CRM", CRM); //Coluna 
...
dbCommand.Parameters.AddWithValue("@DTANIVERSARIO", DTANIVERSARIO); //Coluna 
		...
		public  int Delete(int IDMEDICO)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_MEDICO", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  MEDICOEntity Read(int IDMEDICO)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_MEDICO", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  MEDICOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			MEDICOCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM MEDICO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM MEDICO  ";
					}
				}
				else
				{
		...
		public  MEDICOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			MEDICOCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM MEDICO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static MEDICOCollection ExecuteReader(ref MEDICOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new MEDICOCollection();
		...
		private static MEDICOEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			MEDICOEntity entity = new MEDICOEntity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

							entity.IDMEDICO = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDMEDICO"));
			...
			entity.CRM = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("CRM"));
