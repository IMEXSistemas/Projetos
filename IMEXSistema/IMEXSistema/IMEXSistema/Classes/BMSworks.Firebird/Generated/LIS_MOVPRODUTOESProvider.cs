...
{
	public partial class LIS_MOVPRODUTOESProvider 
	{
		...
		public  LIS_MOVPRODUTOESCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_MOVPRODUTOESCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_MOVPRODUTOES", dbCnn);
		...
		public  LIS_MOVPRODUTOESCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_MOVPRODUTOES WHERE (";
...
public  LIS_MOVPRODUTOESCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_MOVPRODUTOES WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_MOVPRODUTOES  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_MOVPRODUTOESCollection ExecuteReader(ref LIS_MOVPRODUTOESCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_MOVPRODUTOESCollection();
		...
		private static LIS_MOVPRODUTOESEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_MOVPRODUTOESEntity entity = new LIS_MOVPRODUTOESEntity();
			...
			entity.IDTIPOMOVIMENTACAO = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDTIPOMOVIMENTACAO"));
