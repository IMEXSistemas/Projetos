...
{
	public partial class CONSIGNACAOProvider
	{
...
if(IDCONSIGNACAO!= -1)
	dbCommand.Parameters.AddWithValue("@IDCONSIGNACAO", IDCONSIGNACAO); //PrimaryKey 
else
	dbCommand.Parameters.AddWithValue("@IDCONSIGNACAO", DBNull.Value); //PrimaryKey 
...
dbCommand.Parameters.AddWithValue("@TOTAORCAMENTO", TOTAORCAMENTO); //Coluna 
		...
		public  int Delete(int IDCONSIGNACAO)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_CONSIGNACAO", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  CONSIGNACAOEntity Read(int IDCONSIGNACAO)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_CONSIGNACAO", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  CONSIGNACAOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			CONSIGNACAOCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM CONSIGNACAO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM CONSIGNACAO  ";
					}
				}
				else
				{
		...
		public  CONSIGNACAOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			CONSIGNACAOCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM CONSIGNACAO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static CONSIGNACAOCollection ExecuteReader(ref CONSIGNACAOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new CONSIGNACAOCollection();
		...
		private static CONSIGNACAOEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			CONSIGNACAOEntity entity = new CONSIGNACAOEntity();
