...
{
	public partial class LIS_CONTROLEENTREGAProvider 
	{
		...
		public  LIS_CONTROLEENTREGACollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_CONTROLEENTREGACollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_CONTROLEENTREGA", dbCnn);
		...
		public  LIS_CONTROLEENTREGACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_CONTROLEENTREGA WHERE (";
...
public  LIS_CONTROLEENTREGACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_CONTROLEENTREGA WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_CONTROLEENTREGA  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_CONTROLEENTREGACollection ExecuteReader(ref LIS_CONTROLEENTREGACollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_CONTROLEENTREGACollection();
