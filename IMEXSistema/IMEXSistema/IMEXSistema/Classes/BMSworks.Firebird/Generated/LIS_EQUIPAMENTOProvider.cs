...
{
	public partial class LIS_EQUIPAMENTOProvider 
	{
		...
		public  LIS_EQUIPAMENTOCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_EQUIPAMENTOCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_EQUIPAMENTO", dbCnn);
		...
		public  LIS_EQUIPAMENTOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_EQUIPAMENTO WHERE (";
...
public  LIS_EQUIPAMENTOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_EQUIPAMENTO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_EQUIPAMENTO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_EQUIPAMENTOCollection ExecuteReader(ref LIS_EQUIPAMENTOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_EQUIPAMENTOCollection();
		...
		private static LIS_EQUIPAMENTOEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_EQUIPAMENTOEntity entity = new LIS_EQUIPAMENTOEntity();
