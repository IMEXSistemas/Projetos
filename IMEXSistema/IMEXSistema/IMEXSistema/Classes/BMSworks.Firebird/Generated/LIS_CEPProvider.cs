...
{
	public partial class LIS_CEPProvider 
	{
		...
		public  LIS_CEPCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_CEPCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_CEP", dbCnn);
		...
		public  LIS_CEPCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_CEP WHERE (";
...
public  LIS_CEPCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_CEP WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_CEP  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_CEPCollection ExecuteReader(ref LIS_CEPCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_CEPCollection();
		...
		private static LIS_CEPEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_CEPEntity entity = new LIS_CEPEntity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

						entity.IDCEP = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDCEP"));
