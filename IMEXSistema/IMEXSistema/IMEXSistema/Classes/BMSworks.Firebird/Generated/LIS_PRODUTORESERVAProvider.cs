...
{
	public partial class LIS_PRODUTORESERVAProvider 
	{
		...
		public  LIS_PRODUTORESERVACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTORESERVA WHERE (";
...
public  LIS_PRODUTORESERVACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_PRODUTORESERVAEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTORESERVAEntity entity = new LIS_PRODUTORESERVAEntity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

			entity.IDPRODUTORESERVA = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDPRODUTORESERVA"));
			entity.IDRESERVA = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDRESERVA"));
			entity.DATARETIRADA = getData.ConvertDBValueToDateTimeNullable(DataReader, DataReader.GetOrdinal("DATARETIRADA"));
			entity.DATAENTREGA = getData.ConvertDBValueToDateTimeNullable(DataReader, DataReader.GetOrdinal("DATAENTREGA"));
			entity.QUANT = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("QUANT"));
