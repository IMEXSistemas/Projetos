...
{
	public partial class LIS_PRODUTOCOTACAOFORNECEDORProvider 
	{
		...
		~LIS_PRODUTOCOTACAOFORNECEDORProvider()
		{
			dbCnn = null;
			dbCommand = null;
			dbTransaction = null;
		...
		public  LIS_PRODUTOCOTACAOFORNECEDORCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
...
public  LIS_PRODUTOCOTACAOFORNECEDORCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_PRODUTOCOTACAOFORNECEDOREntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTOCOTACAOFORNECEDOREntity entity = new LIS_PRODUTOCOTACAOFORNECEDOREntity();
			...
			entity.DATACOTACAO = getData.ConvertDBValueToDateTime(DataReader, DataReader.GetOrdinal("DATACOTACAO"));
