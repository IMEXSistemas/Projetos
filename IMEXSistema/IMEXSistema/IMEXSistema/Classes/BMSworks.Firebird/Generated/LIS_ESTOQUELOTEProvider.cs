...
{
	public partial class LIS_ESTOQUELOTEProvider
	{
		...
		public  int Save(LIS_ESTOQUELOTEEntity Entity )
		{	
			int result = 0;
		...
		public LIS_ESTOQUELOTEEntity Read(int IDESTOQUELOTE)
		{
			...
			try
			{
                ...
                LIS_ESTOQUELOTEEntity entity = null;
				if (reader.HasRows)
				{
					while (reader.Read())
					{
		...
		public LIS_ESTOQUELOTECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
            LIS_ESTOQUELOTECollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM LIS_ESTOQUELOTE WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_ESTOQUELOTE  ";
					}
				}
				else
				{
		...
		public LIS_ESTOQUELOTECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
            LIS_ESTOQUELOTECollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM LIS_ESTOQUELOTE  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_ESTOQUELOTEEntity FillEntityObject(ref FbDataReader DataReader) 
		{
            LIS_ESTOQUELOTEEntity entity = new LIS_ESTOQUELOTEEntity();
