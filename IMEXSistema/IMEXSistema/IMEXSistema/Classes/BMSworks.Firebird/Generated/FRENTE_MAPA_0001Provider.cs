...
{
	public partial class FRENTE_MAPA_0001Provider
	{
		...
		public  int Save(FRENTE_MAPA_0001Entity Entity )
		{	
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Sav_FRENTE_MAPA_0001", dbCnn);
		...
		public  int Delete()
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_FRENTE_MAPA_0001", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  FRENTE_MAPA_0001Entity Read()
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_FRENTE_MAPA_0001", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				FRENTE_MAPA_0001Entity entity = null;
				if (reader.HasRows)
				{
					while (reader.Read())
					{
		...
		public  FRENTE_MAPA_0001Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			FRENTE_MAPA_0001Collection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM FRENTE_MAPA_0001 WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM FRENTE_MAPA_0001  ";
					}
				}
				else
				{
		...
		public  FRENTE_MAPA_0001Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			FRENTE_MAPA_0001Collection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM FRENTE_MAPA_0001  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static FRENTE_MAPA_0001Collection ExecuteReader(ref FRENTE_MAPA_0001Collection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new FRENTE_MAPA_0001Collection();
		...
		private static FRENTE_MAPA_0001Entity FillEntityObject(ref FbDataReader DataReader) 
		{
			FRENTE_MAPA_0001Entity entity = new FRENTE_MAPA_0001Entity();
