...
{
	public partial class LIS_PRODUTONFProvider 
	{
		...
		public  LIS_PRODUTONFCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_PRODUTONFCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_PRODUTONF", dbCnn);
		...
		public  LIS_PRODUTONFCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTONF WHERE (";
...
public  LIS_PRODUTONFCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_PRODUTONF WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_PRODUTONF  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_PRODUTONFCollection ExecuteReader(ref LIS_PRODUTONFCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_PRODUTONFCollection();
		...
		private static LIS_PRODUTONFEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTONFEntity entity = new LIS_PRODUTONFEntity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

						entity.IDPRODUTONF = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDPRODUTONF"));
