...
{
	public partial class VENDAS_ECFProvider
	{
		...
		public  int Delete()
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_VENDAS_ECF", dbCnn);
		...
		public  VENDAS_ECFCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			VENDAS_ECFCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM VENDAS_ECF WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM VENDAS_ECF  ";
					}
				}
				else
				{
		...
		public  VENDAS_ECFCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			VENDAS_ECFCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM VENDAS_ECF  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static VENDAS_ECFCollection ExecuteReader(ref VENDAS_ECFCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new VENDAS_ECFCollection();
