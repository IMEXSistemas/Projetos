...
{
	public partial class LIS_PEDIDO3Provider 
	{
		...
		public  LIS_PEDIDO3Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PEDIDO3 WHERE (";
...
public  LIS_PEDIDO3Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_PEDIDO3Entity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PEDIDO3Entity entity = new LIS_PEDIDO3Entity();
