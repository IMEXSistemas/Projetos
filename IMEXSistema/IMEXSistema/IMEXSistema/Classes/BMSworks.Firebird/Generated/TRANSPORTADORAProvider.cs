...
{
	public partial class TRANSPORTADORAProvider
	{
...
dbCommand.Parameters.AddWithValue("@CODANTT", Entity.CODANTT); //Coluna 
		...
		public  int Save(int? IDTRANSPORTADORA, string NOME, string NOMEFANTASIA, DateTime DATACADASTRO, string TELEFONE1, string TELEFONE2, string FAX, string CNPJ, string IE, string ENDERECO, string BAIRRO, string CIDADE, string UF, string CEP, string OBSERVACAO, string SITE, string CODANTT)
		{	
			int result = 0;
...
dbCommand.Parameters.AddWithValue("@SITE", SITE); //Coluna 
dbCommand.Parameters.AddWithValue("@CODANTT", CODANTT); //Coluna 
		...
		public  int Delete(int IDTRANSPORTADORA)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_TRANSPORTADORA", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  TRANSPORTADORACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			TRANSPORTADORACollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM TRANSPORTADORA WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM TRANSPORTADORA  ";
					}
				}
				else
				{
		...
		public  TRANSPORTADORACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			TRANSPORTADORACollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM TRANSPORTADORA  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static TRANSPORTADORACollection ExecuteReader(ref TRANSPORTADORACollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new TRANSPORTADORACollection();
