...
{
	public partial class LIS_MATERIALProvider 
	{
		...
		public  LIS_MATERIALCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_MATERIALCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_MATERIAL", dbCnn);
		...
		public  LIS_MATERIALCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_MATERIAL WHERE (";
...
public  LIS_MATERIALCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_MATERIAL WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_MATERIAL  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_MATERIALCollection ExecuteReader(ref LIS_MATERIALCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_MATERIALCollection();
		...
		private static LIS_MATERIALEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_MATERIALEntity entity = new LIS_MATERIALEntity();
