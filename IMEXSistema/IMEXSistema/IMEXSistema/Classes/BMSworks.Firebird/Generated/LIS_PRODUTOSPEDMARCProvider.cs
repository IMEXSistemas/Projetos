...
{
	public partial class LIS_PRODUTOSPEDMARCProvider 
	{
		...
		public  LIS_PRODUTOSPEDMARCCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_PRODUTOSPEDMARCCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_PRODUTOSPEDMARC", dbCnn);
		...
		public  LIS_PRODUTOSPEDMARCCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDMARC WHERE (";
...
public  LIS_PRODUTOSPEDMARCCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDMARC WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDMARC  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_PRODUTOSPEDMARCCollection ExecuteReader(ref LIS_PRODUTOSPEDMARCCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_PRODUTOSPEDMARCCollection();
		...
		private static LIS_PRODUTOSPEDMARCEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTOSPEDMARCEntity entity = new LIS_PRODUTOSPEDMARCEntity();
