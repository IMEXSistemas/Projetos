...
{
	public partial class LIS_CONSIGNACAOProvider 
	{
		...
		public  LIS_CONSIGNACAOCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_CONSIGNACAOCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_CONSIGNACAO", dbCnn);
		...
		public  LIS_CONSIGNACAOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_CONSIGNACAO WHERE (";
...
public  LIS_CONSIGNACAOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_CONSIGNACAO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_CONSIGNACAO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_CONSIGNACAOCollection ExecuteReader(ref LIS_CONSIGNACAOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_CONSIGNACAOCollection();
		...
		private static LIS_CONSIGNACAOEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_CONSIGNACAOEntity entity = new LIS_CONSIGNACAOEntity();
			...
			entity.NOMETRANPORTES = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMETRANPORTES"));
