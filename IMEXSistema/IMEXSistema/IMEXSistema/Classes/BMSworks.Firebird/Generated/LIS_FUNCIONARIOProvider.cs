...
{
	public partial class LIS_FUNCIONARIOProvider 
	{
		...
		public  LIS_FUNCIONARIOCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_FUNCIONARIOCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_FUNCIONARIO", dbCnn);
		...
		public  LIS_FUNCIONARIOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_FUNCIONARIO WHERE (";
...
public  LIS_FUNCIONARIOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_FUNCIONARIO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_FUNCIONARIO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_FUNCIONARIOCollection ExecuteReader(ref LIS_FUNCIONARIOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_FUNCIONARIOCollection();
		...
		private static LIS_FUNCIONARIOEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_FUNCIONARIOEntity entity = new LIS_FUNCIONARIOEntity();
			...
			entity.CODSTATUS = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("CODSTATUS"));
