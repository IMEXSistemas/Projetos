...
{
	public partial class VERSAOSCRIPTProvider
	{
		...
		public  int Save(int? IDVERSAO, string NUMEROVERSAO)
		{	
			int result = 0;
			...
			dbCommand.Parameters.AddWithValue("@NUMEROVERSAO", NUMEROVERSAO); //Coluna 
		...
		public  int Delete(int IDVERSAO)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_VERSAO", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  VERSAOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			VERSAOCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM VERSAO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM VERSAO  ";
					}
				}
				else
				{
		...
		public  VERSAOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			VERSAOCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM VERSAO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static VERSAOCollection ExecuteReader(ref VERSAOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new VERSAOCollection();
