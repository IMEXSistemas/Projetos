...
{
	public partial class MOVCONTACORRENTEProvider
	{
...
dbCommand.Parameters.AddWithValue("@DATAMOVIMENTACAO", Entity.DATAMOVIMENTACAO); //Coluna 
		...
		public  int Save(int? IDMOVCTCORRENTE, string NUMMOVIMENTACAO, int IDCONTACORRENTE, int IDMOVIMENTACAO, int IDTIPOMOVCAIXA, string OBSERVACAO, decimal VALOR, DateTime DATAMOVIMENTACAO)
		{	
			int result = 0;
...
if(IDMOVCTCORRENTE!= -1)
	dbCommand.Parameters.AddWithValue("@IDMOVCTCORRENTE", IDMOVCTCORRENTE); //PrimaryKey 
else
	dbCommand.Parameters.AddWithValue("@IDMOVCTCORRENTE", DBNull.Value); //PrimaryKey 

dbCommand.Parameters.AddWithValue("@NUMMOVIMENTACAO", NUMMOVIMENTACAO); //Coluna 
dbCommand.Parameters.AddWithValue("@IDCONTACORRENTE", IDCONTACORRENTE); //Coluna 
dbCommand.Parameters.AddWithValue("@IDMOVIMENTACAO", IDMOVIMENTACAO); //Coluna 
dbCommand.Parameters.AddWithValue("@IDTIPOMOVCAIXA", IDTIPOMOVCAIXA); //Coluna 
dbCommand.Parameters.AddWithValue("@OBSERVACAO", OBSERVACAO); //Coluna 
dbCommand.Parameters.AddWithValue("@VALOR", VALOR); //Coluna 
dbCommand.Parameters.AddWithValue("@DATAMOVIMENTACAO", DATAMOVIMENTACAO); //Coluna 
		...
		public  int Delete(int IDMOVCTCORRENTE)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_MOVCONTACORRENTE", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  MOVCONTACORRENTEEntity Read(int IDMOVCTCORRENTE)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_MOVCONTACORRENTE", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				MOVCONTACORRENTEEntity entity = null;
				if (reader.HasRows)
				{
					while (reader.Read())
					{
		...
		public  MOVCONTACORRENTECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			MOVCONTACORRENTECollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM MOVCONTACORRENTE WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM MOVCONTACORRENTE  ";
					}
				}
				else
				{
		...
		public  MOVCONTACORRENTECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			MOVCONTACORRENTECollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM MOVCONTACORRENTE  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static MOVCONTACORRENTECollection ExecuteReader(ref MOVCONTACORRENTECollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new MOVCONTACORRENTECollection();
		...
		private static MOVCONTACORRENTEEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			MOVCONTACORRENTEEntity entity = new MOVCONTACORRENTEEntity();
			...
			entity.IDCONTACORRENTE = getData.ConvertDBValueToInt32Nullable(DataReader, DataReader.GetOrdinal("IDCONTACORRENTE"));
			entity.IDMOVIMENTACAO = getData.ConvertDBValueToInt32Nullable(DataReader, DataReader.GetOrdinal("IDMOVIMENTACAO"));
