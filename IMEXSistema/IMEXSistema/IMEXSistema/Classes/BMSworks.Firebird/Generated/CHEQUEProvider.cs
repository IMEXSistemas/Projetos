...
{
	public partial class CHEQUEProvider
	{
		...
		public  int Save(CHEQUEEntity Entity )
		{	
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Sav_CHEQUE", dbCnn);
...
if(Entity.IDCHEQUE!= -1)
	dbCommand.Parameters.AddWithValue("@IDCHEQUE",Entity.IDCHEQUE); //PrimaryKey 
else
	dbCommand.Parameters.AddWithValue("@IDCHEQUE", DBNull.Value); //PrimaryKey 
...
dbCommand.Parameters.AddWithValue("@BOMPARA", Entity.BOMPARA); //Coluna 
...
dbCommand.Parameters.AddWithValue("@NOMECLIENTEFORNEC", Entity.NOMECLIENTEFORNEC); //Coluna 
...
dbCommand.Parameters.AddWithValue("@TITULAR", Entity.TITULAR); //Coluna 
dbCommand.Parameters.AddWithValue("@OBSERVACAO", Entity.OBSERVACAO); //Coluna 
				...
				dbCommand.Parameters["@IDCHEQUE"].Direction = ParameterDirection.InputOutput;

				
				//Executando consulta
				dbCommand.ExecuteNonQuery();
							
			    result = int.Parse(dbCommand.Parameters["@IDCHEQUE"].Value.ToString());
...
if(IDCHEQUE!= -1)
	dbCommand.Parameters.AddWithValue("@IDCHEQUE", IDCHEQUE); //PrimaryKey 
else
	dbCommand.Parameters.AddWithValue("@IDCHEQUE", DBNull.Value); //PrimaryKey 
...
dbCommand.Parameters.AddWithValue("@BOMPARA", BOMPARA); //Coluna 
...
dbCommand.Parameters.AddWithValue("@NOMECLIENTEFORNEC", NOMECLIENTEFORNEC); //Coluna 
...
dbCommand.Parameters.AddWithValue("@TITULAR", TITULAR); //Coluna 
dbCommand.Parameters.AddWithValue("@OBSERVACAO", OBSERVACAO); //Coluna 
		...
		public  int Delete(int IDCHEQUE)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_CHEQUE", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  CHEQUEEntity Read(int IDCHEQUE)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_CHEQUE", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  CHEQUECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			CHEQUECollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM CHEQUE WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM CHEQUE  ";
					}
				}
				else
				{
		...
		public  CHEQUECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			CHEQUECollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM CHEQUE  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static CHEQUECollection ExecuteReader(ref CHEQUECollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
		...
		private static CHEQUEEntity FillEntityObject(ref FbDataReader DataReader) 
		{
