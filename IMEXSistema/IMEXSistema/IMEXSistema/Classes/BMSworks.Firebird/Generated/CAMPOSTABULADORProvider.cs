...
{
	public partial class CAMPOSTABULADORProvider
	{
...
dbCommand.Parameters.AddWithValue("@VALORCAMPO", Entity.VALORCAMPO); //Coluna 
		...
		public  int Save(int? IDCAMPOTABULADOR, string FLAGNEGRITO, int TAMANHO, int LINHA, int COLUNA, int IDTABULADOR, int TAMCAMPO, int IDCAMPOIMPTAB, int IDFONTE, string VALORCAMPO)
		{	
			int result = 0;
...
if(IDCAMPOTABULADOR!= -1)
	dbCommand.Parameters.AddWithValue("@IDCAMPOTABULADOR", IDCAMPOTABULADOR); //PrimaryKey 
else
	dbCommand.Parameters.AddWithValue("@IDCAMPOTABULADOR", DBNull.Value); //PrimaryKey 

dbCommand.Parameters.AddWithValue("@FLAGNEGRITO", FLAGNEGRITO); //Coluna 
dbCommand.Parameters.AddWithValue("@TAMANHO", TAMANHO); //Coluna 
dbCommand.Parameters.AddWithValue("@LINHA", LINHA); //Coluna 
dbCommand.Parameters.AddWithValue("@COLUNA", COLUNA); //Coluna 
dbCommand.Parameters.AddWithValue("@IDTABULADOR", IDTABULADOR); //Coluna 
dbCommand.Parameters.AddWithValue("@TAMCAMPO", TAMCAMPO); //Coluna 
dbCommand.Parameters.AddWithValue("@IDCAMPOIMPTAB", IDCAMPOIMPTAB); //Coluna 
dbCommand.Parameters.AddWithValue("@IDFONTE", IDFONTE); //Coluna 
dbCommand.Parameters.AddWithValue("@VALORCAMPO", VALORCAMPO); //Coluna 
		...
		public  int Delete(int IDCAMPOTABULADOR)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_CAMPOSTABULADOR", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  CAMPOSTABULADORCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			CAMPOSTABULADORCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM CAMPOSTABULADOR WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM CAMPOSTABULADOR  ";
					}
				}
				else
				{
		...
		public  CAMPOSTABULADORCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			CAMPOSTABULADORCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM CAMPOSTABULADOR  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static CAMPOSTABULADORCollection ExecuteReader(ref CAMPOSTABULADORCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new CAMPOSTABULADORCollection();
