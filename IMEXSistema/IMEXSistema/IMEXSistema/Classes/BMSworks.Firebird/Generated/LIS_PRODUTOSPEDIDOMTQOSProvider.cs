...
{
	public partial class LIS_PRODUTOSPEDIDOMTQOSProvider 
	{
		...
		~LIS_PRODUTOSPEDIDOMTQOSProvider()
		{
			dbCnn = null;
			dbCommand = null;
			dbTransaction = null;
		...
		public  LIS_PRODUTOSPEDIDOMTQOSCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_PRODUTOSPEDIDOMTQOSCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_PRODUTOSPEDIDOMTQOS", dbCnn);
		...
		public  LIS_PRODUTOSPEDIDOMTQOSCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDIDOMTQOS WHERE (";
...
public  LIS_PRODUTOSPEDIDOMTQOSCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDIDOMTQOS WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDIDOMTQOS  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_PRODUTOSPEDIDOMTQOSCollection ExecuteReader(ref LIS_PRODUTOSPEDIDOMTQOSCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_PRODUTOSPEDIDOMTQOSCollection();
		...
		private static LIS_PRODUTOSPEDIDOMTQOSEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTOSPEDIDOMTQOSEntity entity = new LIS_PRODUTOSPEDIDOMTQOSEntity();
