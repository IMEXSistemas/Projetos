...
{
	public partial class PRODUTONFProvider
	{
		...
		public  int Save(PRODUTONFEntity Entity )
		{	
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Sav_PRODUTONF", dbCnn);
...
if(Entity.IDPRODUTONF!= -1)
	dbCommand.Parameters.AddWithValue("@IDPRODUTONF",Entity.IDPRODUTONF); //PrimaryKey 
else
	dbCommand.Parameters.AddWithValue("@IDPRODUTONF", DBNull.Value); //PrimaryKey 

dbCommand.Parameters.AddWithValue("@IDNOTAFISCAL", Entity.IDNOTAFISCAL); //Coluna 
...
dbCommand.Parameters.AddWithValue("@IDCLASSFISCAL", Entity.IDCLASSFISCAL); //Coluna 
...
dbCommand.Parameters.AddWithValue("@IDUNIDADE", Entity.IDUNIDADE); //Coluna 
				...
				dbCommand.Parameters["@IDPRODUTONF"].Direction = ParameterDirection.InputOutput;

				
				//Executando consulta
				dbCommand.ExecuteNonQuery();
							
			    result = int.Parse(dbCommand.Parameters["@IDPRODUTONF"].Value.ToString());
		...
		public  int Save(int? IDPRODUTONF, int IDNOTAFISCAL, int IDPRODUTO, decimal QUANTIDADE, decimal VALORUNITARIO, decimal VALORTOTAL, decimal COMISSAO, decimal ALICMS, decimal REDICMS, decimal VALORICMS, decimal ALIPI, decimal VALORIPI, int IDCLASSFISCAL, int IDCST, decimal BASEICMS, int IDUNIDADE)
		{	
			int result = 0;
...
if(IDPRODUTONF!= -1)
	dbCommand.Parameters.AddWithValue("@IDPRODUTONF", IDPRODUTONF); //PrimaryKey 
else
	dbCommand.Parameters.AddWithValue("@IDPRODUTONF", DBNull.Value); //PrimaryKey 

dbCommand.Parameters.AddWithValue("@IDNOTAFISCAL", IDNOTAFISCAL); //Coluna 
...
dbCommand.Parameters.AddWithValue("@IDCLASSFISCAL", IDCLASSFISCAL); //Coluna 
...
dbCommand.Parameters.AddWithValue("@IDUNIDADE", IDUNIDADE); //Coluna 
		...
		public  int Delete(int IDPRODUTONF)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_PRODUTONF", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  PRODUTONFEntity Read(int IDPRODUTONF)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_PRODUTONF", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  PRODUTONFCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			PRODUTONFCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTONF WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTONF  ";
					}
				}
				else
				{
		...
		public  PRODUTONFCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			PRODUTONFCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTONF  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static PRODUTONFCollection ExecuteReader(ref PRODUTONFCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new PRODUTONFCollection();
		...
		private static PRODUTONFEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			PRODUTONFEntity entity = new PRODUTONFEntity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

							entity.IDPRODUTONF = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDPRODUTONF"));
			entity.IDNOTAFISCAL = getData.ConvertDBValueToInt32Nullable(DataReader, DataReader.GetOrdinal("IDNOTAFISCAL"));
