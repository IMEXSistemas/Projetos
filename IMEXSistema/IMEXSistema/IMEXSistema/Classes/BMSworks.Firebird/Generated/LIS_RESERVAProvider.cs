...
{
	public partial class LIS_RESERVAProvider 
	{
		...
		public  LIS_RESERVACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_RESERVA WHERE (";
...
public  LIS_RESERVACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_RESERVAEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_RESERVAEntity entity = new LIS_RESERVAEntity();
			...
			entity.VLPAGO = getData.ConvertDBValueToDecimalNullable(DataReader, DataReader.GetOrdinal("VLPAGO"));
