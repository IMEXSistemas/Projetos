...
{
	public partial class LIS_PRODUTOS2Provider 
	{
		...
		public  LIS_PRODUTOS2Collection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_PRODUTOS2Collection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_PRODUTOS2", dbCnn);
		...
		public  LIS_PRODUTOS2Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTOS2 WHERE (";
...
public  LIS_PRODUTOS2Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_PRODUTOS2 WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_PRODUTOS2  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_PRODUTOS2Collection ExecuteReader(ref LIS_PRODUTOS2Collection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_PRODUTOS2Collection();
		...
		private static LIS_PRODUTOS2Entity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTOS2Entity entity = new LIS_PRODUTOS2Entity();
