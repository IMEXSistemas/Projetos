...
{
	public partial class FRENTE_MAPA_0002Provider
	{
		...
		public  int Save(FRENTE_MAPA_0002Entity Entity )
		{	
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Sav_FRENTE_MAPA_0002", dbCnn);
...
dbCommand.Parameters.AddWithValue("@SINCRONIZADO", SINCRONIZADO); //Coluna 
		...
		public  FRENTE_MAPA_0002Entity Read()
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_FRENTE_MAPA_0002", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				FRENTE_MAPA_0002Entity entity = null;
				if (reader.HasRows)
				{
					while (reader.Read())
					{
		...
		public  FRENTE_MAPA_0002Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			FRENTE_MAPA_0002Collection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM FRENTE_MAPA_0002 WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM FRENTE_MAPA_0002  ";
					}
				}
				else
				{
		...
		public  FRENTE_MAPA_0002Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			FRENTE_MAPA_0002Collection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM FRENTE_MAPA_0002  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static FRENTE_MAPA_0002Collection ExecuteReader(ref FRENTE_MAPA_0002Collection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new FRENTE_MAPA_0002Collection();
		...
		private static FRENTE_MAPA_0002Entity FillEntityObject(ref FbDataReader DataReader) 
		{
			FRENTE_MAPA_0002Entity entity = new FRENTE_MAPA_0002Entity();
