...
{
	public partial class LIS_PEDIDOOTICAProvider 
	{
		...
		public  LIS_PEDIDOOTICACollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_PEDIDOOTICACollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_PEDIDOOTICA", dbCnn);
		...
		public  LIS_PEDIDOOTICACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PEDIDOOTICA WHERE (";
...
public  LIS_PEDIDOOTICACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_PEDIDOOTICA WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_PEDIDOOTICA  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_PEDIDOOTICAEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PEDIDOOTICAEntity entity = new LIS_PEDIDOOTICAEntity();
			...
			entity.DESCRICAOCENTROCUSTO = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("DESCRICAOCENTROCUSTO"));
			entity.IDMEDICO = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDMEDICO"));
			entity.NOMEMEDICO = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMEMEDICO"));
			entity.CRMMEDICO = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("CRMMEDICO"));
			entity.IDFORNECEDOR = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDFORNECEDOR"));
			entity.NOMEFORN = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMEFORN"));
