...
{
	public partial class LIS_PRODUTONFEProvider 
	{
		...
		public  LIS_PRODUTONFECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTONFE WHERE (";
...
public  LIS_PRODUTONFECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_PRODUTONFEEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTONFEEntity entity = new LIS_PRODUTONFEEntity();
			...
			entity.CODCOMPL = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("CODCOMPL"));
