...
{
	public partial class LIS_EQUIPAMENTOOSFECHProvider 
	{
		...
		public  LIS_EQUIPAMENTOOSFECHCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_EQUIPAMENTOOSFECH WHERE (";
...
public  LIS_EQUIPAMENTOOSFECHCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_EQUIPAMENTOOSFECHEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_EQUIPAMENTOOSFECHEntity entity = new LIS_EQUIPAMENTOOSFECHEntity();
