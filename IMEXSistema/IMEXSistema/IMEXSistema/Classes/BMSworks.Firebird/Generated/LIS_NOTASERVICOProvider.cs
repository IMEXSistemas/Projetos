...
{
	public partial class LIS_NOTASERVICOProvider 
	{
		...
		public  LIS_NOTASERVICOCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_NOTASERVICOCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_NOTASERVICO", dbCnn);
		...
		public  LIS_NOTASERVICOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_NOTASERVICO WHERE (";
...
public  LIS_NOTASERVICOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_NOTASERVICO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_NOTASERVICO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_NOTASERVICOCollection ExecuteReader(ref LIS_NOTASERVICOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_NOTASERVICOCollection();
		...
		private static LIS_NOTASERVICOEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_NOTASERVICOEntity entity = new LIS_NOTASERVICOEntity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

						entity.IDNOTASERVICO = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDNOTASERVICO"));
			entity.NPS = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("NPS"));
			entity.DATAEMISSAO = getData.ConvertDBValueToDateTimeNullable(DataReader, DataReader.GetOrdinal("DATAEMISSAO"));
			entity.CODNATUREZA = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("CODNATUREZA"));
			entity.REGIMETRIBUTACAO = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("REGIMETRIBUTACAO"));
