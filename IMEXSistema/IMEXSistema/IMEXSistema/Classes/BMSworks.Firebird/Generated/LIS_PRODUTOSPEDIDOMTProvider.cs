...
{
	public partial class LIS_PRODUTOSPEDIDOMTProvider 
	{
		...
		public  LIS_PRODUTOSPEDIDOMTCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_PRODUTOSPEDIDOMTCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_PRODUTOSPEDIDOMT", dbCnn);
		...
		public  LIS_PRODUTOSPEDIDOMTCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDIDOMT WHERE (";
...
public  LIS_PRODUTOSPEDIDOMTCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDIDOMT WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_PRODUTOSPEDIDOMT  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_PRODUTOSPEDIDOMTCollection ExecuteReader(ref LIS_PRODUTOSPEDIDOMTCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_PRODUTOSPEDIDOMTCollection();
		...
		private static LIS_PRODUTOSPEDIDOMTEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTOSPEDIDOMTEntity entity = new LIS_PRODUTOSPEDIDOMTEntity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

						entity.IDPRODUTOSPEDIDOMT = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDPRODUTOSPEDIDOMT"));
