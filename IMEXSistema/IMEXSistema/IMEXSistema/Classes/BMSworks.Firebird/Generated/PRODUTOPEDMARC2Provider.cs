...
{
	public partial class PRODUTOPEDMARC2Provider
	{
		...
		public  int Save(int? IDPRODUTOPEDMARC2, int PEDIDOMARC, decimal QUANT, decimal ALTURA, decimal LARGURA, decimal COMPRIMENTO, decimal TOTALMT3, decimal VLUNITARIO, decimal VLTOTAL, string DADOSADICIONAIS, int IDPRODUTO)
		{	
			int result = 0;
			...
			try
			{
				...
				dbCommand.CommandType = CommandType.StoredProcedure;
									...
									//PrimaryKey com valor igual a null, indica um novo registro, 
									//o valor da chave será fornecido pelo banco. Qualquer outro valor indicará edição do registro.
									if (IDPRODUTOPEDMARC2 == -1)
										dbCommand.Parameters.AddWithValue("@IDPRODUTOPEDMARC2", DBNull.Value);
									else
										dbCommand.Parameters.AddWithValue("@IDPRODUTOPEDMARC2", IDPRODUTOPEDMARC2);
										
										
										if(PEDIDOMARC!= null)
											dbCommand.Parameters.AddWithValue("@PEDIDOMARC", PEDIDOMARC); //ForeignKey 
										else
											dbCommand.Parameters.AddWithValue("@PEDIDOMARC", DBNull.Value); //ForeignKey 5
										...
										dbCommand.Parameters.AddWithValue("@TOTALMT3", TOTALMT3); //Coluna 
		...
		public  int Delete(int IDPRODUTOPEDMARC2)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_PRODUTOPEDMARC2", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				dbCommand.Parameters.AddWithValue("@IDPRODUTOPEDMARC2",IDPRODUTOPEDMARC2); //PrimaryKey
		...
		public  PRODUTOPEDMARC2Entity Read(int IDPRODUTOPEDMARC2)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Rea_PRODUTOPEDMARC2", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
				...
				PRODUTOPEDMARC2Entity entity = null;
				if (reader.HasRows)
				{
					while (reader.Read())
					{
		...
		public  PRODUTOPEDMARC2Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			PRODUTOPEDMARC2Collection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTOPEDMARC2 WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTOPEDMARC2  ";
					}
				}
				else
				{
		...
		public  PRODUTOPEDMARC2Collection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			PRODUTOPEDMARC2Collection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTOPEDMARC2  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static PRODUTOPEDMARC2Collection ExecuteReader(ref PRODUTOPEDMARC2Collection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new PRODUTOPEDMARC2Collection();
		...
		private static PRODUTOPEDMARC2Entity FillEntityObject(ref FbDataReader DataReader) 
		{
			PRODUTOPEDMARC2Entity entity = new PRODUTOPEDMARC2Entity();

			FirebirdGetDbData getData = new FirebirdGetDbData();

							entity.IDPRODUTOPEDMARC2 = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDPRODUTOPEDMARC2"));
			entity.PEDIDOMARC = getData.ConvertDBValueToInt32Nullable(DataReader, DataReader.GetOrdinal("PEDIDOMARC"));
