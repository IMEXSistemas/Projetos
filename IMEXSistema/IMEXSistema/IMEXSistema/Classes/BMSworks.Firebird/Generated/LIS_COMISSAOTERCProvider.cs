...
{
	public partial class LIS_COMISSAOTERCProvider 
	{
		...
		public  LIS_COMISSAOTERCCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_COMISSAOTERC WHERE (";
...
public  LIS_COMISSAOTERCCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_COMISSAOTERCEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_COMISSAOTERCEntity entity = new LIS_COMISSAOTERCEntity();
