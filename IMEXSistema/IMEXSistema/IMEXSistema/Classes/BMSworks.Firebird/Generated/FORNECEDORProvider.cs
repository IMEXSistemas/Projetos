...
{
	public partial class FORNECEDORProvider
	{
...
dbCommand.Parameters.AddWithValue("@NUMERO", Entity.NUMERO); //Coluna 
		...
		public  int Save(int? IDFORNECEDOR, string NOME, string NOMEFANTASIA, DateTime DATACADASTRO, string TELEFONE1, string TELEFONE2, string CNPJ, string IE, string ENDERECO, string BAIRRO, string CIDADE, string UF, string CEP, string EMAILFORNECEDOR, string OBSERVACAO, int IDTRANSPORTADORA, string CONTATOTRANPORTADORA, string EMAILTRANSPORTADORA, string NUMERO)
		{	
			int result = 0;
...
dbCommand.Parameters.AddWithValue("@EMAILFORNECEDOR", EMAILFORNECEDOR); //Coluna 
...
dbCommand.Parameters.AddWithValue("@CONTATOTRANPORTADORA", CONTATOTRANPORTADORA); //Coluna 
dbCommand.Parameters.AddWithValue("@EMAILTRANSPORTADORA", EMAILTRANSPORTADORA); //Coluna 
dbCommand.Parameters.AddWithValue("@NUMERO", NUMERO); //Coluna 
				...
				dbCommand.Parameters["@IDFORNECEDOR"].Direction = ParameterDirection.ReturnValue;
				
				//Executando consulta
				dbCommand.ExecuteNonQuery();
							
			    result = (int)(dbCommand.Parameters["@IDFORNECEDOR"].Value);
		...
		public  int Delete(int IDFORNECEDOR)
		{
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_FORNECEDOR", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  FORNECEDORCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			FORNECEDORCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM FORNECEDOR WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM FORNECEDOR  ";
					}
				}
				else
				{
		...
		public  FORNECEDORCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			FORNECEDORCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM FORNECEDOR  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static FORNECEDORCollection ExecuteReader(ref FORNECEDORCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new FORNECEDORCollection();
