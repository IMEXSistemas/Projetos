...
{
	public partial class LIS_PEDIDOMARCProvider 
	{
		...
		public  LIS_PEDIDOMARCCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PEDIDOMARC WHERE (";
...
public  LIS_PEDIDOMARCCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_PEDIDOMARCEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PEDIDOMARCEntity entity = new LIS_PEDIDOMARCEntity();
