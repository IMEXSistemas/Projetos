...
{
	public partial class PRODUTOCOMPOSICAOProvider
	{
		...
		public  int Save(int? IDPRODUTOCOMPOSICAO, int IDFORNECEDOR, int IDPRODUTO, decimal QUANTIDADE, int IDUNIDADE, decimal VALOR, int IDPRODUTOMAIN, decimal VALORTOTAL, string FLAGEXIBIR, string FLAGMATERIAPRIMA)
		{	
			int result = 0;
			...
			try
			{
				...
				dbCommand.CommandType = CommandType.StoredProcedure;
									...
									//PrimaryKey com valor igual a null, indica um novo registro, 
									//o valor da chave será fornecido pelo banco. Qualquer outro valor indicará edição do registro.
									if (IDPRODUTOCOMPOSICAO == -1)
										dbCommand.Parameters.AddWithValue("@IDPRODUTOCOMPOSICAO", DBNull.Value);
									else
										dbCommand.Parameters.AddWithValue("@IDPRODUTOCOMPOSICAO", IDPRODUTOCOMPOSICAO);
										...
										if(IDPRODUTOMAIN!= null)
											dbCommand.Parameters.AddWithValue("@IDPRODUTOMAIN", IDPRODUTOMAIN); //ForeignKey 
										else
											dbCommand.Parameters.AddWithValue("@IDPRODUTOMAIN", DBNull.Value); //ForeignKey 5
										...
										dbCommand.Parameters.AddWithValue("@FLAGMATERIAPRIMA", FLAGMATERIAPRIMA); //Coluna 
		...
		public  int Delete(int IDPRODUTOCOMPOSICAO)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_PRODUTOCOMPOSICAO", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  PRODUTOCOMPOSICAOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			PRODUTOCOMPOSICAOCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTOCOMPOSICAO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTOCOMPOSICAO  ";
					}
				}
				else
				{
		...
		public  PRODUTOCOMPOSICAOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			PRODUTOCOMPOSICAOCollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM PRODUTOCOMPOSICAO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static PRODUTOCOMPOSICAOCollection ExecuteReader(ref PRODUTOCOMPOSICAOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new PRODUTOCOMPOSICAOCollection();
