...
{
	public partial class LIS_ESTOQUEESProvider 
	{
		...
		public  LIS_ESTOQUEESCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_ESTOQUEESCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_ESTOQUEES", dbCnn);
		...
		public  LIS_ESTOQUEESCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_ESTOQUEES WHERE (";
...
public  LIS_ESTOQUEESCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_ESTOQUEES WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_ESTOQUEES  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_ESTOQUEESCollection ExecuteReader(ref LIS_ESTOQUEESCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_ESTOQUEESCollection();
		...
		private static LIS_ESTOQUEESEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_ESTOQUEESEntity entity = new LIS_ESTOQUEESEntity();
			...
			entity.NOMETIPOMOVIMENTACAO = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMETIPOMOVIMENTACAO"));
			entity.DATAMOVIM = getData.ConvertDBValueToDateTimeNullable(DataReader, DataReader.GetOrdinal("DATAMOVIM"));
			entity.IDCODMOVIMENTACAO = getData.ConvertDBValueToInt32(DataReader, DataReader.GetOrdinal("IDCODMOVIMENTACAO"));
			entity.NOMEMOVIMENTACAO = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMEMOVIMENTACAO"));
			entity.CODIGOMOVIMENTACAO = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("CODIGOMOVIMENTACAO"));
