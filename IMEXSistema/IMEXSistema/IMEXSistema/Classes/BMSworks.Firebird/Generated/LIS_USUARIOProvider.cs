...
{
	public partial class LIS_USUARIOProvider 
	{
		...
		public  LIS_USUARIOCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_USUARIOCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_USUARIO", dbCnn);
		...
		public  LIS_USUARIOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_USUARIO WHERE (";
...
public  LIS_USUARIOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_USUARIO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_USUARIO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_USUARIOCollection ExecuteReader(ref LIS_USUARIOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_USUARIOCollection();
		...
		private static LIS_USUARIOEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_USUARIOEntity entity = new LIS_USUARIOEntity();
			...
			entity.NOMENIVELUSUARIO = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMENIVELUSUARIO"));
