...
{
	public partial class LIS_SCRIPTVERSAO2Provider 
	{
		...
		public void BeginTransaction(FbTransaction _dbTransaction, string connectionString)
		{
			try
			{
		...
		public void BeginTransaction(IsolationLevel NivelIsolamento, string connectionString)
		{
			try
			{
				if (dbTransaction == null)
