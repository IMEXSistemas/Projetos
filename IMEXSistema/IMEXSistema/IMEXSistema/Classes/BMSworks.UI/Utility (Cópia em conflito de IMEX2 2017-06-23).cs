...
namespace BMSworks.UI
{
    public partial class Utility
    {
        ...
        public void ArquivoRemessaCaixa_CNAB240(LIS_DUPLICATARECEBERCollection DuplicatasColl, string extensao)
        {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    if (sfd.ShowDialog() == DialogResult.OK)
                    {
                        try
                        {
                            ...
                            linha_HEADER_LOTE += CONFIGBOLETATy.DIGAGENCIA.ToString().PadLeft(1, ' ');
                           ...
                           linha_HEADER_LOTE += string.Empty.ToString().PadRight(8, '0');
                            ...
                            foreach (LIS_DUPLICATARECEBEREntity item in DuplicatasColl)
                            {
                                ...
                                //08.3Q     Tipo de Inscrição do Pagador    18      18          9(001)      Preencher com o tipo de inscrição do Pagador: '1', se CPF(pessoa física);                                     ou '2' se CNPJ(pessoa jurídica)
                                 if (ClieteTy.CPF != "   .   .   -")
                                    ...
                                    LINHA_DETALHE_SEGMENTO_Q += LimiterText(RetiraLetras(ClieteTy.CEP1).ToString().PadLeft(5, '0'), 5);
                            ...
                            //DESCRIÇÃO DE REGISTRO TIPO ‘‘5’’ (Obrigatório)
                            ...
                            int Contador_1_3_5 = 2;
                            int TotalRegistros = Contador_1_3_5 + (contadorlinha * 2);
                            LINHA_TRAILLER_LOTE += TotalRegistros.ToString().PadLeft(6, '0');
                           ...
                           LINHA_TRAILLER_LOTE += string.Empty.ToString().PadRight(6, '0');
                            ...
                            //Totalização da Cobrança Descontada
                            //Campo     Nome do campo                                               de     ate        "Picture"     Conteúd
                            //11.5      Quantidade de Títulos em Carteiras Descontadas              76      92          9(017)      Preencher com zeros 
                            LINHA_TRAILLER_LOTE += string.Empty.ToString().PadRight(17, '0');
                            ...
                            //Totais 
                            //Campo     Nome do campo                           de     ate        "Picture"     Conteúd
                            //06.9      Quantidade de Registros do Arquivo      24      29          9(006)      Informar o Número do total de registros enviados no arquivo; tratase da somatória dos registros de tipo 0, 1, 3, 5 e 9
                            //06.9	024	029	006	-	Num			Qtde. de Registros		Quantidade de Registros do Arquivo		
                            Contador_1_3_5 = 4;
                            TotalRegistros = Contador_1_3_5 + (contadorlinha * 2);
                            linha3 +=  TotalRegistros.ToString().PadLeft(6, '0');
                    ...
                    if (sfd.ShowDialog() == DialogResult.OK)
                    {
                        try
                        {
                           ...
                           // 06.0	019	032	    014	-	Num			Número		Número de Inscrição da Empresa		
                            ...
                            //07.0	033	052	    020	-	Alfa		Convênio			Código do Convênio no Sicoob: Brancos		
                            linha += string.Empty.ToString().PadRight(20, ' ');

                            // 08.0	053	057	    005	-	Num	Prefixo da Cooperativa: vide planilha "Capa" deste arquivo		Conta Corrente³	Agência	Código	
                            linha += CONFIGBOLETATy.AGENCIA.ToString().PadLeft(5, '0');

                           //  09.0	058	058	    001	-	Alfa				DV	Dígito Verificador do Prefixo: vide planilha "Capa" deste arquivo	
                            linha += CONFIGBOLETATy.DIGAGENCIA.ToString().PadLeft(1, ' ');
                          ...
                          //  19.0	158	163	    006	-	Num		Seqüência (NSA)			
                           ...
                           //09.1	018	018	001	-	Num	Empresa	Inscrição	Tipo		"Tipo de Inscrição da Empresa:
                            ...
                            linha_HEADER_LOTE += string.Empty.ToString().PadRight(20, ' ');
                            ...
                            linha_HEADER_LOTE += CONFIGBOLETATy.DIGCONTA.ToString().PadLeft(1, ' ');
                           ...
                           //21.1	192	199	    008	-	Num			Dt. Gravação		Data de Gravação Remessa/Retorno		
                            ...
                            foreach (LIS_DUPLICATARECEBEREntity item in DuplicatasColl)
                            {
                                if (item.IDDUPLICATARECEBER != null && item.IDSTATUS != 3) //3 Pago 
                                {
                                   ...
                                   // 01.3P	001	003	003	-	Num	Controle¹	Banco			Código do Banco na Compensação: "756"		
                                    ...
                                    // 04.3P	009	013	005	-	Num	Serviço	Nº do Registro			
                                    ...
                                    //LINHA_DETALHE_SEGMENTO_P += sequencia.ToString().PadLeft(5, '0');
                                    //Mudança no dia 07/04/2014 as 16:22
                                    LINHA_DETALHE_SEGMENTO_P += ContadorSequencia.ToString().PadLeft(5, '0');
                                      ContadorSequencia++;
                                    ...
                                    //06.3P	015	015	001	-	Alfa		CNAB			Uso Exclusivo FEBRABAN/CNAB: Brancos		
                                    LINHA_DETALHE_SEGMENTO_P += string.Empty.ToString().PadRight(01, ' ');

                                    //07.3P	016	017	002	-	Num		Cód. Mov.			"Código de Movimento Remessa:
                                    ...
                                    //08.3P	018	022	005	-	Num	C/C	Agência	Código		Prefixo da Cooperativa: vide planilha "Capa" deste arquivo		
                                    LINHA_DETALHE_SEGMENTO_P += CONFIGBOLETATy.AGENCIA.ToString().PadLeft(5, '0');

                                    //09.3P	023	023	001	-	Alfa			DV		Dígito Verificador do Prefixo: vide planilha "Capa" deste arquivo		
                                    LINHA_DETALHE_SEGMENTO_P += CONFIGBOLETATy.DIGCONTA.ToString().PadLeft(1, ' ');

                                    //10.3P	024	035	012	-	Num		Conta	Número		Conta Corrente: vide planilha "Capa" deste arquivo	
                                    LINHA_DETALHE_SEGMENTO_P += CONFIGBOLETATy.CONTA.ToString().PadLeft(12, '0');

                                     //11.3P	036	036	001	-	Alfa			DV		Dígito Verificador da Conta: vide planilha "Capa" deste arquivo		
                                    LINHA_DETALHE_SEGMENTO_P += CONFIGBOLETATy.DIGCONTA.ToString().PadLeft(1, ' ');

                                     //12.3P	037	037	001	-	Alfa		DV			Dígito Verificador da Ag/Conta: Brancos		
                                    LINHA_DETALHE_SEGMENTO_P += string.Empty.ToString().PadRight(1, ' ');

                                    //13.3P	038	057	020	-	Alfa	Nosso Número				"Nosso Número:
                                    ...
                                    //14.3P	058	058	001	-	Num	Característica Cobrança	Carteira			Código da Carteira: vide planilha "Capa" deste arquivo		
                                     LINHA_DETALHE_SEGMENTO_P += "1";
                                   ...
                                   // 15.3P	059	059	001	-	Num		Cadastramento			Forma de Cadastr. do Título no Banco: "0"		
                                    ...
                                    //16.3P	060	060	001	-	Alfa		Documento			Tipo de Documento: Brancos		
                                     ...
                                     //17.3P	061	061	001	-	Num		Emissão Boleto			"Identificação da Emissão do Boleto: (vide planilha ""Capa"" deste arquivo)
                                     //     '1'  =  Sicoob Emite
                                     //     '2'  =  Cedente Emite"	
                                     LINHA_DETALHE_SEGMENTO_P += "2";

                                     // 18.3P	062	062	001	-	Alfa		Distrib. Boleto			"Identificação da Distribuição do Boleto: (vide planilha ""Capa"" deste arquivo)
                                     // '1'  =  Sicoob Distribui
                                     // '2'  =  Cedente Distribui"	
                                     LINHA_DETALHE_SEGMENTO_P += "2";
                                   ...
                                   // 22.3P	101	105	005	-	Num	Ag. Cobradora				Agência Encarregada da Cobrança: "00000"		
                                    ...
                                    // 23.3P	106	106	001	-	Alfa	DV				Dígito Verificador da Agência: Brancos		
                                     LINHA_DETALHE_SEGMENTO_P += string.Empty.ToString().PadRight(01, ' ');

                                    //24.3P	107	108	002	-	Num	Espécie de Título				"Espécie do Título:
                                    //'01'  =  CH Cheque
                                   ...
                                   // 27.3P	118	118	001	-	Num	Juros	Cód. Juros Mora			"Código do Juros de Mora:
                                    //'1'  =  Valor por Dia
                                    //'2'  =  Taxa Mensal
                                    //'3'  =  Isento"		
                                     LINHA_DETALHE_SEGMENTO_P += "3";

                                    //28.3P	119	126	008	-	Num		Data Juros Mora 			Data do Juros de Mora		
                                     LINHA_DETALHE_SEGMENTO_P += Convert.ToDateTime(item.DATAVECTO).ToString("ddMMyyyy");

                                    //29.3P	127	141	013	002	Num		Juros Mora			Juros de Mora por Dia/Taxa		
                                     LINHA_DETALHE_SEGMENTO_P += "000000000000000";

                                    //30.3P	142	142	001	-	Num	Desc 1	Cód. Desc. 1			"Código do Desconto 1
                                    ...
                                    //35.3P	196	220	025	-	Alfa	Uso Empresa Cedente			
                                    //Identificação do Título na Empresa: Campo destinado para uso do Cedente para identificação do Título.		
                                     LINHA_DETALHE_SEGMENTO_P += string.Empty.ToString().PadRight(25, ' ');

                                    //36.3P	221	221	001	-	Num	Código p/ Protesto				Código para Protesto: "1"	
                                     LINHA_DETALHE_SEGMENTO_P += "1";

                                    //37.3P	222	223	002	-	Num	Prazo p/ Protesto				Número de Dias Corridos para Protesto
                                     LINHA_DETALHE_SEGMENTO_P += "05";
                                    ...
                                    //39.3P	225	227	003	-	Alfa	Prazo p/ Baixa/Devolução				Número de Dias para Baixa/Devolução: Brancos		
                                     LINHA_DETALHE_SEGMENTO_P += "999";

                                   // 40.3P	228	229	002	-	Num	Código da Moeda				"Código da Moeda:
                                   ...
                                   //10.3Q	34	73	    40	-	Alfa					Nome		
                                    LINHA_DETALHE_SEGMENTO_Q += LimiterText(ClieteTy.NOME, 40).ToString().PadRight(40, ' ');

                                    //11.3Q	74	113	40	-	Alfa					Endereço		
                                    LINHA_DETALHE_SEGMENTO_Q += LimiterText(ClieteTy.ENDERECO1 + " " + ClieteTy.NUMEROENDER , 40).ToString().PadRight(40, ' ');

                                   //12.3Q	114	128	15	-	Alfa					Bairro		
                                    LINHA_DETALHE_SEGMENTO_Q += LimiterText(ClieteTy.BAIRRO1, 15).ToString().PadRight(15, ' ');
                                  ...
                                  //13.3Q	129	133	    5	-	Num					CEP		
                                    ...
                                    MUNICIPIOSTy = MUNICIPIOSProvider.Read(Convert.ToInt32(ClieteTy.COD_MUN_IBGE));
                                    LINHA_DETALHE_SEGMENTO_Q += LimiterText(MUNICIPIOSTy.MUNICIPIO, 15).PadRight(15, ' ');
                                   ...
                                   //19.3Q	170	209	40	-	Alfa	Nome do Sacador/Avalista				Nome do Sacador/Avalista		
                                    ...
                                    //INICIO - REGISTRO DETALHE SEGMENTO R
                                    //////////////////////////////////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
                                    string LINHA_DETALHE_SEGMENTO_R = null;

                                    //SEQ	Posição		Nº	    Nº	    Form	Campo / Descrição / Conteúdo						
                                    //       De	Até	    Dig	    Dec								

                                   //01.3R	001	003	    003	- 	Num	Controle	Banco			Código do Banco na Compensação: "756"		
                                    LINHA_DETALHE_SEGMENTO_R += "756";
                                   ...
                                   //02.3R	004	007	    004	-	Num		Lote			
                                    ...
                                    LINHA_DETALHE_SEGMENTO_R += "0001";

                                    //03.3R	008	008	    001	-	Num		Registro			Tipo de Registro: "3"		
                                    LINHA_DETALHE_SEGMENTO_R += "3";

                                    //04.3R	009	013	005	-	Num	Serviço	Nº do Registro			
                                    //"Nº Sequencial do Registro no Lote: Número adotado e controlado pelo responsável pela 
                                    //geração magnética dos dados contidos no arquivo, para identificar a seqüência de
                                    //registros encaminhados no lote. Deve ser inicializado sempre em '1', em cada novo lote."		
                                  
                                    //Alterado dia 07/04/2017 - 16:49
                                    //LINHA_DETALHE_SEGMENTO_R += sequencia.ToString().PadLeft(5, '0');
                                    LINHA_DETALHE_SEGMENTO_R += ContadorSequencia.ToString().PadLeft(5, '0');
                                    ContadorSequencia++;

                                    //05.3R	014	014	    001	-	Alfa		Segmento			Cód. Segmento do Registro Detalhe: "R"		
                                    LINHA_DETALHE_SEGMENTO_R += "R";

                                    //06.3R	015	015	    001	-	Alfa		CNAB			Uso Exclusivo FEBRABAN/CNAB: Brancos		
                                    LINHA_DETALHE_SEGMENTO_R += string.Empty.ToString().PadRight(1, ' ');

                                    //	07.3R	016	017	002	-	Num		Cód. Mov.			"Código de Movimento Remessa:
                                    //'01'  =  Entrada de Títulos
                                    //'02'  =  Pedido de Baixa
                                    //'04'  =  Concessão de Abatimento
                                    //'05'  =  Cancelamento de Abatimento
                                    ...
                                    //'35'  =  Pedido de Desagendamento do Débito Automático
                                    //'40'  =  Alteração de Carteira"
                                    LINHA_DETALHE_SEGMENTO_R += "01";

                                    //	08.3R	018	018	    001	-	Num	Desc2	Cód. Desc. 2			"Código do Desconto 2
                                   // '1'  =  Valor Fixo Até a Data Informada
                                    //'2'  =  Percentual Até a Data Informada"	
                                    LINHA_DETALHE_SEGMENTO_R += "1";

                                    //09.3R	019	026	    008	-	Num		Data Desc. 2			Data do Desconto 2
                                    LINHA_DETALHE_SEGMENTO_R += DateTime.Now.ToString("ddMMyyyy");

                                    //10.3R	027	041	    013	    002	Num		Desconto 2			Valor/Percentual a ser Concedido		
                                    LINHA_DETALHE_SEGMENTO_R += "000000000000000";

                                   //11.3R	042	042	    001	-	Num	Desc3	Cód. Desc. 3			"Código do Desconto 3: ""0""
                                    //'1'  =  Valor Fixo Até a Data Informada
                                    //'2'  =  Percentual Até a Data Informada"
                                    LINHA_DETALHE_SEGMENTO_R += "0";

                                    //12.3R	043	    	-	Num		Data Desc. 3			Data do Desconto 3: "00000000"		
                                    LINHA_DETALHE_SEGMENTO_R += "00000000";

                                    //13.3R	051	065	    013	002	Num		Desconto 3			Valor/Percentual a ser Concedido: "000000000000000"		
                                    LINHA_DETALHE_SEGMENTO_R += "000000000000000";

                                    //14.3R	066	066	    001	-	Alfa	Multa	Cód. Multa			"Código da Multa:
                                    //'1'  =  Valor Fixo
                                    //'2'  =  Percentual"		
                                    LINHA_DETALHE_SEGMENTO_R += "1";

                                    //15.3R	067	074	    008	-	Num		Data da Multa			Data da Multa		
                                    LINHA_DETALHE_SEGMENTO_R += "00000000";

                                    //16.3R	075	089	    013	002	Num		Multa			Valor/Percentual a Ser Aplicado		
                                    LINHA_DETALHE_SEGMENTO_R += "000000000000000";

                                    //17.3R	090	099	    010	-	Alfa	Informação ao Sacado				Informação ao Sacado: Brancos		
                                    LINHA_DETALHE_SEGMENTO_R += string.Empty.ToString().PadRight(10, ' ');

                                    //18.3R	100	139	    040	-	Alfa	Informação 3				
                                    //"Mensagem 3: Texto de observações destinado ao envio de mensagens livres, a
                                    //serem impressas no campo de instruções da ficha de compensação do bloqueto.
                                    //As Mensagens 3 e 4 prevalecem sobre as mensagens 1 e 2."	
                                    LINHA_DETALHE_SEGMENTO_R += string.Empty.ToString().PadRight(40, ' ');

                                    //19.3R	140	179	040	-	Alfa	Informação 4				
                                    //"Mensagem 4: Texto de observações destinado ao envio de mensagens livres, a 
                                    //serem impressas no campo de instruções da ficha de compensação do bloqueto.
                                    //As Mensagens 3 e 4 prevalecem sobre as mensagens 1 e 2."		
                                    LINHA_DETALHE_SEGMENTO_R += string.Empty.ToString().PadRight(40, ' ');

                                    //20.3R	180	199	    020	-	Alfa	CNAB				Uso Exclusivo FEBRABAN/CNAB: Brancos		
                                    LINHA_DETALHE_SEGMENTO_R += string.Empty.ToString().PadRight(20, ' ');

                                    //21.3R	200	207	008	-	Num	Cod. Ocor. Sacado				Cód. Ocor. do Sacado: "00000000"		
                                    LINHA_DETALHE_SEGMENTO_R += "00000000";

                                    //22.3R	208	210	003	-	Num	Dados para Débito	Banco			Cód. do Banco na Conta do Débito: "000"		
                                    LINHA_DETALHE_SEGMENTO_R += "000";

                                    //23.3R	211	215	005	-	Num		Agência			Código da Agência do Débito: "00000"		
                                    LINHA_DETALHE_SEGMENTO_R += "00000";

                                    //24.3R.	216	216	    001	-	Alfa					Dígito Verificador da Agência: Brancos		
                                    LINHA_DETALHE_SEGMENTO_R += string.Empty.ToString().PadRight(1, ' ');

                                    //25.3R	217	228	012	-	Num		Conta Corrente 			Conta Corrente para Débito: "000000000000"		
                                    LINHA_DETALHE_SEGMENTO_R += "000000000000";

                                    //26.3R	229	229	001	-	Alfa					Dígito Verificador da Conta: Brancos		
                                    LINHA_DETALHE_SEGMENTO_R += string.Empty.ToString().PadRight(1, ' ');

                                    //27.3R	230	230	001	-	Alfa		DV			Dígito Verificador Ag/Conta: Brancos		
                                    LINHA_DETALHE_SEGMENTO_R += string.Empty.ToString().PadRight(1, ' ');

                                   //28.3R	231	231	001	-	Num	Ident. da Emissão do Aviso Déb.				Aviso para Débito Automático: "0"		
                                    LINHA_DETALHE_SEGMENTO_R += string.Empty.ToString().PadRight(1, '0');

                                   //29.3R	232	240	009	-	Alfa	CNAB				Uso Exclusivo FEBRABAN/CNAB: Brancos		
                                    LINHA_DETALHE_SEGMENTO_R += string.Empty.ToString().PadRight(9, ' ');

                                    sw.WriteLine(LINHA_DETALHE_SEGMENTO_R);
                                    
                                    //FIM - REGISTRO DETALHE SEGMENTO R
                                    //////////////////////////////////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\

                                    //FIM - REGISTRO DETALHE SEGMENTO S
                                    //////////////////////////////////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
                                    string LINHA_DETALHE_SEGMENTO_S = null;

                                    //	SEQ	Posição		Nº	Nº	Form	Campo / Descrição / Conteúdo						
		                                   //De	Até	    Dig	Dec	
                                    //01.3S	001	003	    003	- 	Num	Controle	Banco			Código do Banco na Compensação: "756"		
                                    LINHA_DETALHE_SEGMENTO_S += "756";

                                    //02.3S	004	007	    004	-	Num		Lote			"Lote de Serviço: Número seqüencial para identificar univocamente um 
                                    //lote de serviço. Criado e controlado pelo responsável pela geração magnética dos dados contidos no arquivo.
                                        //Preencher com '0001' para o primeiro lote do arquivo. Para os demais: número do lote anterior 
                                    //acrescido de 1. O número não poderá ser repetido dentro do arquivo."
                                    LINHA_DETALHE_SEGMENTO_S += "0001";

                                    //03.3S	008	008	    001	-	Num		Registro			Tipo de Registro: "3"		
                                    LINHA_DETALHE_SEGMENTO_S += "3";

                                   //04.3S	009	013	    005	-	Num	Serviço	Nº do Registro			
                                    //"Nº Sequencial do Registro no Lote: Número adotado e controlado pelo responsável pela 
                                    //geração magnética dos dados contidos no arquivo, para identificar a seqüência de registros 
                                    //encaminhados no lote. Deve ser inicializado sempre em '1', em cada novo lote."		
                                    
                                    //Alterado dia 16:50
                                    //LINHA_DETALHE_SEGMENTO_S += sequencia.ToString().PadLeft(5, '0');
                                    LINHA_DETALHE_SEGMENTO_S += ContadorSequencia.ToString().PadLeft(5, '0');
                                    ContadorSequencia++;

                                    //05.3S	014	014	       001	-	Alfa		Segmento			Cód. Segmento do Registro Detalhe: "S"		
                                    LINHA_DETALHE_SEGMENTO_S += "S";

                                    //06.3S	015	015	       001	-	Alfa		CNAB			Uso Exclusivo FEBRABAN/CNAB: Brancos		
                                    LINHA_DETALHE_SEGMENTO_S +=  string.Empty.ToString().PadRight(1, ' ');

                                    //	07.3S	016	017	    002	-	Num		Cód. Mov.			"Código de Movimento Remessa:
                                    //'01'  =  Entrada de Títulos
                                    //'02'  =  Pedido de Baixa
                                    //'04'  =  Concessão de Abatimento
                                    //'05'  =  Cancelamento de Abatimento
                                    ...
                                    //'35'  =  Pedido de Desagendamento do Débito Automático
                                    //'40'  =  Alteração de Carteira"	
                                    LINHA_DETALHE_SEGMENTO_S += "01";

                                    //08.3S	018	018	    001	-	Num	Tipo de Impressão				"Identificação da Impressão:
                                    //'1'  =  Frente do Bloqueto
                                    //'2'  =  Verso do Bloqueto"		
                                    LINHA_DETALHE_SEGMENTO_S += "1";

                                    //09.3S	019	020	    002	-	Num	Nº da Linha				Número da Linha a ser Impressa		
                                    LINHA_DETALHE_SEGMENTO_S += "01";

                                   //10.3S	021	160	    040	-	Alfa	Mensagem				Mensagem a ser impressa		
                                    LINHA_DETALHE_SEGMENTO_S += string.Empty.ToString().PadRight(40, ' ');

                                    //11.3S	161	162	    002	-	Num	Tipo de Fonte				Tipo de caracter a ser impresso	
                                    LINHA_DETALHE_SEGMENTO_S += string.Empty.ToString().PadRight(2, ' ');

                                    //12.3S	163	240	    078	-	Alfa	CNAB				Uso Exclusivo FEBRABAN/CNAB		
                                    LINHA_DETALHE_SEGMENTO_S += string.Empty.ToString().PadRight(78, ' ');
                                    ...
                                    //"Mensagem 5: Texto de observações destinado ao envio de mensagens livres, a 
                                    //serem impressas no campo de instruções da ficha de compensação do bloqueto.
                                    //As mensagens 5 à 9 prevalecem sobre as anteriores."		
                                   // LINHA_DETALHE_SEGMENTO_S += string.Empty.ToString().PadRight(40, ' ');

                                    //	10.3S	059	098	    040	-	Alfa	Informação 6				
                                    //"Mensagem 6: Texto de observações destinado ao envio de mensagens livres, 
                                    //a serem impressas no campo de instruções da ficha de compensação do bloqueto.
                                    //As mensagens 5 à 9 prevalecem sobre as anteriores."
                                   // LINHA_DETALHE_SEGMENTO_S += string.Empty.ToString().PadRight(40, ' ');

                                    //	11.3S	099	138	    040	-	Alfa	Informação 7			
                                    //"Mensagem 7: Texto de observações destinado ao envio de mensagens livres, a 
                                    //serem impressas no campo de instruções da ficha de compensação do bloqueto.
                                    //As mensagens 5 à 9 prevalecem sobre as anteriores."	
                                   // LINHA_DETALHE_SEGMENTO_S += string.Empty.ToString().PadRight(40, ' ');

                                    //12.3S	139	178	    040	-	Alfa	Informação 8			
                                    //"Mensagem 8: Texto de observações destinado ao envio de mensagens livres, a
                                    //serem impressas no campo de instruções da ficha de compensação do bloqueto.
                                    //As mensagens 5 à 9 prevalecem sobre as anteriores."		
                                  //  LINHA_DETALHE_SEGMENTO_S += string.Empty.ToString().PadRight(40, ' ');

                                    //	13.3S	179	218	    040	-	Alfa	Informação 9				
                                    //"Mensagem 9: Texto de observações destinado ao envio de mensagens livres, a serem 
                                    //impressas no campo de instruções da ficha de compensação do bloqueto.
                                    //As mensagens 5 à 9 prevalecem sobre as anteriores."	
                                    //LINHA_DETALHE_SEGMENTO_S += string.Empty.ToString().PadRight(40, ' ');

                                    //	14.3S	219	240 	022	-	Alfa	CNAB				Uso Exclusivo FEBRABAN/CNAB: Brancos		
                                    //LINHA_DETALHE_SEGMENTO_S += string.Empty.ToString().PadRight(22, ' ');
                                    LINHA_DETALHE_SEGMENTO_S += string.Empty.ToString().PadRight(99, ' ');
                                    sw.WriteLine(LINHA_DETALHE_SEGMENTO_S);
                            ...
                            LINHA_TRAILLER_LOTE += contadorlinha.ToString().PadRight(17, '0');

                            //12.5	093	098	    006	-	Nim	Totalização da Cobrança Descontada				Quantidade de Títulos em Cobrança		
                            LINHA_TRAILLER_LOTE += contadorlinha.ToString().PadRight(6, '0');

                            //13.5	099	115	    015	002	Num					Valor Total dos Títulos em Carteiras
                            LINHA_TRAILLER_LOTE += RetiraLetras(ValorTotalDuplicatas.ToString("n2")).PadLeft(17, '0');

                            //14.5	116	123	    008	-	Alfa	N. do Aviso				Número do Aviso de Lançamento: Brancos		
                           ...
                           // 05.9	018	023	006	-	Num	Totais		Qtde. de Lotes		Quantidade de Lotes do Arquivo		
                            ...
                            //06.9	024	029	006	-	Num			Qtde. de Registros		Quantidade de Registros do Arquivo		
                            linha3 += contadorlinha.ToString().PadRight(6, '0');
        ...
        public Boolean BaixarArquivoFTP(string FileUrl, string local)
        {
            ...
            string url = "ftp://143.95.75.225/public_html/" + FileUrl;
            string usuario = "imexsist";
            string senha = "l8a3C5k8Ki";
