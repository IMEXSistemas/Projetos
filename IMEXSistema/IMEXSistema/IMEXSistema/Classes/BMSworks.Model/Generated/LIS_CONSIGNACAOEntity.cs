...
{
	[Serializable]
	public partial class LIS_CONSIGNACAOEntity
	{
		...
		private string _NOMETRANPORTES;
		...
		//Construtor default
		public LIS_CONSIGNACAOEntity() { }

		public LIS_CONSIGNACAOEntity(int? IDCONSIGNACAO, int? IDCLIENTE, string NOMECLIENTE, DateTime? DTEMISSAO, DateTime? DTVALIDADE, int? IDSTATUS, string NOMESTATUS, string PRAZOENTREGA, int? IDFORMAPAGTO, string NOMEFORMAPGTO, int? IDFUNCIONARIO, string NOMEFUNCIONARIO, int? IDTRANSPORTES, string NOMETRANPORTES, string OBSERVACAO, decimal? TOTALIPI, decimal? PORCDESCONTO, decimal? TOTALDESCONTO, decimal? PORCACRESCIMO, decimal? TOTALACRESCIMO, decimal? TOTAORCAMENTO)		{
			...
			this._NOMETRANPORTES = NOMETRANPORTES;
		...
		public string NOMETRANPORTES
		{
			get { return _NOMETRANPORTES; }
			set { _NOMETRANPORTES = value; }
		}
