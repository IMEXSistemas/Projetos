...
{
	[Serializable]
	public partial class EMPRESAEMISSORAEntity
	{
		...
		//Construtor default
		public EMPRESAEMISSORAEntity() {
			this._COD_MUN_IBGE = null;
		}

		public EMPRESAEMISSORAEntity(int IDEMPRESAEMISSORA, string RAZAOSOCIAL, string NOMEFANTASIA, string TELEFONE, string CNPJ, string IE, string EMAIL, string ENDERECO, string NUMERO, string COMPLEMENTO, string BAIRRO, string CEP, string IMUNICIPAL, string CRT, string IEST, string CNAE, string NOMECERTIFICADO, string SERIACERTIFICADO, string VALIDADECERTIFICADO, int? COD_MUN_IBGE) {
