...
{
	[Serializable]
	public partial class LIS_PEDIDOEntity
	{
        ...
        private DateTime? _HORAVENDA;

        #region Construtores

        //Construtor default
        public LIS_PEDIDOEntity() { }

		public LIS_PEDIDOEntity(int? IDPEDIDO, int? IDCLIENTE, string NOMECLIENTE, DateTime? DTEMISSAO, int? IDSTATUS, 
                                string NOMESTATUS, string PRAZOENTREGA, int? IDTRANSPORTES, string NOMETRANSPORTES, 
                                int? IDVENDEDOR, string NOMEVENDEDOR, decimal? VALORCOMISSAO, string OBSERVACAO, 
                                decimal? TOTALPRODUTOS, decimal? TOTALIMPOSTOS, decimal? PORCDESCONTO, decimal? VALORDESCONTO, 
                                decimal? PORCACRESCIMO, decimal? VALORACRESCIMO, decimal? TOTALPEDIDO, int? IDFORMAPAGAMENTO,
                                string NOMEFORMAPAGTO, decimal? VALORPAGO, decimal? VALORDEVEDOR, int? IDLOCALCOBRANCA, 
                                string NOMELOCALCOBRANCA, int? IDCENTROCUSTOS, string DESCCENTROCUSTO, string CENTROCUSTO,
                                string FLAGPRODIMPRESSAO, string PRODUTOFINAL, string FLAGORCAMENTO, string NREFERENCIA,
                                DateTime? DATAENTREGA, DateTime? DATAVECTO, int? IDSUPERVISOR, string NOMESUPERVISOR,
                                int? IDMESA, string NUMEROMESA, DateTime? HORAVENDA)		{
        ...
        public DateTime? HORAVENDA
        {
            get { return _HORAVENDA; }
            set { _HORAVENDA = value; }
        }
