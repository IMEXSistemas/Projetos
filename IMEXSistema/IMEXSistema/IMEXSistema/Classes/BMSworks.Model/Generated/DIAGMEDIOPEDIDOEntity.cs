...
{
	[Serializable]
	public partial class DIAGMEDIOPEDIDOEntity
	{
		private int _IDDIAGMEDIOPEDIDO;
		...
		//Construtor default
		public DIAGMEDIOPEDIDOEntity() {
			this._IDPEDIDO = null;
		}

		public DIAGMEDIOPEDIDOEntity(int IDDIAGMEDIOPEDIDO, int? IDPEDIDO, string DIRESFERICO, string DIRCILINDRICO, string DIREIXO, string DIRADICAO, string DIRDNP, string DIRACO, string ESQESFERICO, string ESQCILINDRICO, string ESQEIXO, string ESQADICAO, string ESQDNP, string ESQACO, string LENTES, string ARMACAO, string DISTANCIAPUPILAR, string DIREITO, string ESQUERDO, string DPA, string MD, string MV) {

			this._IDDIAGMEDIOPEDIDO = IDDIAGMEDIOPEDIDO;
		...
		public int IDDIAGMEDIOPEDIDO
		{
			get { return _IDDIAGMEDIOPEDIDO; }
			set { _IDDIAGMEDIOPEDIDO = value; }
		}
