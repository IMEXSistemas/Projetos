...
{
	[Serializable]
	public partial class LIS_FORNECEDOREntity
	{
		...
		//Construtor default
		public LIS_FORNECEDOREntity() { }

		public LIS_FORNECEDOREntity(int? IDFORNECEDOR, string NOME, string NOMEFANTASIA, DateTime? DATACADASTRO, string TELEFONE1, string TELEFONE2, string CNPJ, string IE, string ENDERECO, string BAIRRO, string CIDADE, string UF, string CEP, string EMAILFORNECEDOR, string OBSERVACAO, int? IDTRANSPORTADORA, string CONTATOTRANPORTADORA, string EMAILTRANSPORTADORA, string NOMETRANSPORTADORA)		{
