...
{
	[Serializable]
	public partial class LIS_EQUIPAMENTOEntity
	{
		...
		//Construtor default
		public LIS_EQUIPAMENTOEntity() { }

		public LIS_EQUIPAMENTOEntity(int? IDEQUIPAMENTO, string NOME, string OBSERVACAO, string CACAMBA, string PESOOPERACIONAL, string CONSUMOHORA, string PROFESCAVACAO, string POTENCIAHP, decimal? VALOR, int? IDSTATUS, string NOMESTATUS, string LOCALIZACAO, byte FOTO, decimal? VALORDIA, decimal? VALORMES, string IDENTIFICACAO)		{
