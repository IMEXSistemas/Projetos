...
{
	[Serializable]
	public partial class LIS_MEDICOEntity
	{
		...
		//Construtor default
		public LIS_MEDICOEntity() { }

		public LIS_MEDICOEntity(int? IDMEDICO, string NOME, decimal? COMISSAO, DateTime? DATAADMISSAO, string CRM, int? CODSTATUS, string FUNCAO, string DEPARTAMENTO, string SETOR, string CARTEIRATRABALHO, string CARTEIRAMOTORISTA, string CPF, string RG, string ENDERECO, string BAIRRO, string CIDADE, string CEP, string UF, string TELEFONE1, string TELEFONE2, string EMAIL, string NOMESTATUS, string OBSERVACAO, DateTime? DTANIVERSARIO)		{
