...
namespace BMSworks.Model
{
	...
	public partial class CLIENTEEntity
	{
		...
		public CLIENTEEntity() {
			...
			this._DATANASCIMENTOCLIENTE = null;
			this._RENDACLIENTE = null;
			this._CREDITOCLIENTE = null;
			this._IDCLASSIFICACAO = null;
			this._IDTIPOREGIAO = null;
			this._IDPROFISSAOATIVIDADE = null;
			this._IDTRANSPORTADORA = null;
			this._IDFUNCIONARIO = null;
			this._DATANASCCONJUGE = null;
			this._RENDACONJUGE = null;
			this._DATAADMISSAOCONJUGE = null;
			this._DATARETORNOCONTATO = null;
			this._COD_MUN_IBGE = null;
		}

		public CLIENTEEntity(int IDCLIENTE, string NOME, string APELIDO, string CONTATO, DateTime? DATACADASTRO, string TELEFONE1, string TELEFONE2, string FAX, string RAMAL, string CNPJ, string CPF, string IE, string ENDERECO1, string COMPLEMENTO1, string BAIRRO1, string CEP1, string ENDERECO2, string COMPLEMENTO2, string CIDADE2, string UF2, string CEP2, string REFERENCIA1, string TELEFONEREFERENCIA1, string EMAILCLIENTE, DateTime? DATANASCIMENTOCLIENTE, string FLAGSERASA, string FLAGSPC, string FLAGTELECHEQUE, string FLAGBLOQUEADO, string REFERENCIA2, string TELEFONEREFERENCIA2, decimal? RENDACLIENTE, decimal? CREDITOCLIENTE, string OBSERVACAO, int? IDCLASSIFICACAO, int? IDTIPOREGIAO, int? IDPROFISSAOATIVIDADE, int? IDTRANSPORTADORA, int? IDFUNCIONARIO, string EMPREGOCLIENTE, string ENDERECOEMPREGOCLIENTE, string TELEFONEEMPREGOCLIENTE, string CARGOCLIENTE, string ESTADOCIVIL, string NATURALIDADE, string CONJUGE, DateTime? DATANASCCONJUGE, string CPFCONJUGE, string RGCONJUGE, decimal? RENDACONJUGE, string EMPREGOCONJUGE, DateTime? DATAADMISSAOCONJUGE, string CARGOCONJUGE, string TELEFONCONJUGE, string FILIACAO, string NOMECONTATO, string ATENDIDOCONTATO, DateTime? DATARETORNOCONTATO, string DETALHESCONTATO, int? COD_MUN_IBGE, string NUMEROENDER) {
