...
{
	[Serializable]
	public partial class LIS_FUNCIONARIOEntity
	{
		...
		private string _FLAGEXIBIRAGENDA;

		#region Construtores

		//Construtor default
		public LIS_FUNCIONARIOEntity() { }

		public LIS_FUNCIONARIOEntity(int? IDFUNCIONARIO, string NOME, decimal? COMISSAO, DateTime? DATAADMISSAO, decimal? SALARIO, int? CODSTATUS, string FUNCAO, string DEPARTAMENTO, string SETOR, string CARTEIRATRABALHO, string CARTEIRAMOTORISTA, string CPF, string RG, string ENDERECO, string BAIRRO, string CIDADE, string CEP, string UF, string TELEFONE1, string TELEFONE2, string EMAIL, string NOMESTATUS, string OBSERVACAO, DateTime? DTANIVERSARIO, string FLAGEXIBIRAGENDA)		{
			...
			this._FLAGEXIBIRAGENDA = FLAGEXIBIRAGENDA;
		}
		#endregion
		...
		public string FLAGEXIBIRAGENDA
		{
			get { return _FLAGEXIBIRAGENDA; }
			set { _FLAGEXIBIRAGENDA = value; }
		}
