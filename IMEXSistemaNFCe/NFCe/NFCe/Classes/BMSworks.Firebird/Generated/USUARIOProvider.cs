...
dbCommand.Parameters.AddWithValue("@OBSERVACAO", OBSERVACAO); //Coluna 
		...
		public  USUARIOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM USUARIO  ";
					}
				}
				else
				{
		...
		private static USUARIOCollection ExecuteReader(ref USUARIOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
