		...
		{	
			...
			try
			{
				...
				if (Entity.CUPOMELETRONICOID == -1)
					...
					dbCommand.Parameters.AddWithValue("@VALOPAGODINHEIRO", Entity.VALOPAGODINHEIRO); //Coluna 
					dbCommand.Parameters.AddWithValue("@VALOPAGOCARTAOCREDITO", Entity.VALOPAGOCARTAOCREDITO); //Coluna 
					dbCommand.Parameters.AddWithValue("@VALOPAGOVALEREFEICAO", Entity.VALOPAGOVALEREFEICAO); //Coluna 
					dbCommand.Parameters.AddWithValue("@VALORPAGOCHEQUE", Entity.VALORPAGOCHEQUE); //Coluna 
					dbCommand.Parameters.AddWithValue("@VALOPAGOCARTAODEBITO", Entity.VALOPAGOCARTAODEBITO); //Coluna 
					dbCommand.Parameters.AddWithValue("@VALOPAGOOUTROS", Entity.VALOPAGOOUTROS); //Coluna 
			...
			try
			{
				...
				dbCommand.CommandType = CommandType.StoredProcedure;
									...
									if (CUPOMELETRONICOID == -1)
										...
										dbCommand.Parameters.AddWithValue("@VALOPAGODINHEIRO", VALOPAGODINHEIRO); //Coluna 
										dbCommand.Parameters.AddWithValue("@VALOPAGOCARTAOCREDITO", VALOPAGOCARTAOCREDITO); //Coluna 
										dbCommand.Parameters.AddWithValue("@VALOPAGOVALEREFEICAO", VALOPAGOVALEREFEICAO); //Coluna 
										dbCommand.Parameters.AddWithValue("@VALORPAGOCHEQUE", VALORPAGOCHEQUE); //Coluna 
										dbCommand.Parameters.AddWithValue("@VALOPAGOCARTAODEBITO", VALOPAGOCARTAODEBITO); //Coluna 
										dbCommand.Parameters.AddWithValue("@VALOPAGOOUTROS", VALOPAGOOUTROS); //Coluna 
