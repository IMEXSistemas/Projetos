...
{
	public partial class TIPODUPLICATAProvider
	{
...
dbCommand.Parameters.AddWithValue("@OBSERVACAO", Entity.OBSERVACAO); //Coluna 
		...
		public  int Save(int? IDTIPODUPLICATA, string NOME, string OBSERVACAO)
		{	
			int result = 0;
...
dbCommand.Parameters.AddWithValue("@OBSERVACAO", OBSERVACAO); //Coluna 
		...
		public  int Delete(int IDTIPODUPLICATA)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_TIPODUPLICATA", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  TIPODUPLICATACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			TIPODUPLICATACollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM TIPODUPLICATA WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM TIPODUPLICATA  ";
					}
				}
				else
				{
		...
		public  TIPODUPLICATACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			TIPODUPLICATACollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM TIPODUPLICATA  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static TIPODUPLICATACollection ExecuteReader(ref TIPODUPLICATACollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new TIPODUPLICATACollection();
