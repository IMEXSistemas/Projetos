...
if(Entity.IDFUNCIONARIO!= -1)
	dbCommand.Parameters.AddWithValue("@IDFUNCIONARIO",Entity.IDFUNCIONARIO); //PrimaryKey 
else
	dbCommand.Parameters.AddWithValue("@IDFUNCIONARIO", DBNull.Value); //PrimaryKey 
...
dbCommand.Parameters.AddWithValue("@CODSTATUS", CODSTATUS); //Coluna 
