...
{
	public partial class LIS_PRODUTONFCEProvider 
	{
		...
		public  LIS_PRODUTONFCECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PRODUTONFCE WHERE (";
...
public  LIS_PRODUTONFCECollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_PRODUTONFCEEntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_PRODUTONFCEEntity entity = new LIS_PRODUTONFCEEntity();
