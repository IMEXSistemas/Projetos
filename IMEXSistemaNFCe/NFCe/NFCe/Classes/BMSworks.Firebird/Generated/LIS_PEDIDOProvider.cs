...
{
	public partial class LIS_PEDIDOProvider 
	{
		...
		public  LIS_PEDIDOCollection ReadCollection()
		{
			FbDataReader dataReader = null;

			try
			{
				LIS_PEDIDOCollection collection = null;
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("SELECT * FROM LIS_PEDIDO", dbCnn);
		...
		public  LIS_PEDIDOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_PEDIDO WHERE (";
...
public  LIS_PEDIDOCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						strSqlCommand = "SELECT * FROM LIS_PEDIDO WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LIS_PEDIDO  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LIS_PEDIDOCollection ExecuteReader(ref LIS_PEDIDOCollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LIS_PEDIDOCollection();
