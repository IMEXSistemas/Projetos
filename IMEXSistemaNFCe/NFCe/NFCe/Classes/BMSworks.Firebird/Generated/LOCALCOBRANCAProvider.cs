...
{
	public partial class LOCALCOBRANCAProvider
	{
...
dbCommand.Parameters.AddWithValue("@OBSERVACAO", Entity.OBSERVACAO); //Coluna 
		...
		public  int Save(int? IDLOCALCOBRANCA, string CODIGOCOBRANCA, string NOME, string OBSERVACAO)
		{	
			int result = 0;
...
if(IDLOCALCOBRANCA!= -1)
	dbCommand.Parameters.AddWithValue("@IDLOCALCOBRANCA", IDLOCALCOBRANCA); //PrimaryKey 
else
	dbCommand.Parameters.AddWithValue("@IDLOCALCOBRANCA", DBNull.Value); //PrimaryKey 

dbCommand.Parameters.AddWithValue("@CODIGOCOBRANCA", CODIGOCOBRANCA); //Coluna 
...
dbCommand.Parameters.AddWithValue("@OBSERVACAO", OBSERVACAO); //Coluna 
		...
		public  int Delete(int IDLOCALCOBRANCA)
		{
			int result = 0;
			...
			try
			{
				...
				if (dbTransaction != null)
				{
					...
					dbCommand = new FbCommand("Del_LOCALCOBRANCA", dbCnn);
					dbCommand.Transaction = ((FbTransaction)(dbTransaction));
				}
				else
				{
		...
		public  LOCALCOBRANCACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			LOCALCOBRANCACollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM LOCALCOBRANCA WHERE (";
					...
					{
						strSqlCommand = "SELECT * FROM LOCALCOBRANCA  ";
					}
				}
				else
				{
		...
		public  LOCALCOBRANCACollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro, string FieldOrder)
		{
			FbDataReader dataReader = null;
			LOCALCOBRANCACollection collection = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					...
					{
						strSqlCommand = "SELECT * FROM LOCALCOBRANCA  order by  " + FieldOrder;
					}
				}
				else
				{
		...
		private static LOCALCOBRANCACollection ExecuteReader(ref LOCALCOBRANCACollection collection, ref FbDataReader dataReader, FbCommand dbCommand)
		{
			using (dataReader = dbCommand.ExecuteReader())
			{
				collection = new LOCALCOBRANCACollection();
