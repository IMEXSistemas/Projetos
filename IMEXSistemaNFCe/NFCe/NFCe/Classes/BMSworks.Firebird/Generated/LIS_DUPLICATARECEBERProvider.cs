...
{
	public partial class LIS_DUPLICATARECEBERProvider 
	{
		...
		public  LIS_DUPLICATARECEBERCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro)
		{
			FbDataReader dataReader = null;
			...
			try
			{
				if (RowsFiltro != null)
				{
					if (RowsFiltro.Count > 0)
					{
						...
						string strSqlCommand = "SELECT * FROM LIS_DUPLICATARECEBER WHERE (";
...
public  LIS_DUPLICATARECEBERCollection ReadCollectionByParameter(List<RowsFiltro> RowsFiltro,  string FieldOrder)
		...
		private static LIS_DUPLICATARECEBEREntity FillEntityObject(ref FbDataReader DataReader) 
		{
			LIS_DUPLICATARECEBEREntity entity = new LIS_DUPLICATARECEBEREntity();
			...
			entity.NOMEVEND = getData.ConvertDBValueToStringNullable(DataReader, DataReader.GetOrdinal("NOMEVEND"));
