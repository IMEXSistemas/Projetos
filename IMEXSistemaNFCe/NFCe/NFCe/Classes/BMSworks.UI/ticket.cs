...
namespace BMSworks.UI
{
    ...
    public class Ticket
    {
        ...
        public Boolean DrawItems_b
        {
            get { return drawItems_b; }
            set { if (drawItems_b != value) drawItems_b = value; }
        }
        ...
        private void DrawItems()
        {
            ...
            gfx.DrawString("QUANT DESCRICAO            VALOR", printFont, myBrush, leftMargin, YPosition(), new StringFormat());
