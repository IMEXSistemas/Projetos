...
namespace BMSworks.Model
{
	...
	public partial class PRODUTOSEntity
	{
		...
		public PRODUTOSEntity(int IDPRODUTO, string NOMEPRODUTO, string CODPRODUTOFORNECEDOR, string CODBARRA, string LOCALIZACAO, DateTime? DATACADASTRO, int? IDUNIDADE, int? IDMARCA, int? IDMOEDA, decimal? VALORCUSTOINICIAL, decimal? FRETEPRODUTO, decimal? ENCARGOSPRODUTOS, decimal? VALORCUSTOFINAL, decimal? MARGEMLUCRO, decimal? VALORVENDA1, decimal? VALORVENDA2, decimal? VALORVENDA3, decimal? COMISSAO, decimal? IPI, decimal? ICMS, decimal? QUANTIDADEMINIMA, int? IDGRUPOCATEGORIA, int? IDSTATUS, string OBSERVACAO, decimal? PORCFRETE, decimal? PORCENCARGOS, decimal? PORCMARGEMLUCRO, decimal? PORCVENDA2, decimal? PORCVENDA3, decimal? PESO, int? IDCLASSIFICACAO, int? IDCST, string NCMSH, string EXTIPI, decimal? ALIQPIS, decimal? ALIQCOFINS, string CSTPISCONFIS, string FLAGDECIMALREND, int? MULTAREND, string FLAGBAIXAESTMT, int? IDLOTE, decimal? ESTOQUEMANUAL, string SITUACAOTRIBUTARIA, string CSTPIS, string CSTIPI, int? IDCSTECF, string TIPOITEM, decimal? PORCPERDAPROD, string DADOSADICIONAIS, string FLAGICMSST) {
