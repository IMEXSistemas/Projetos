...
namespace BMSworks.Model
{
	...
	public partial class LIS_PRODUTONFCEEntity
	{
		...
		public LIS_PRODUTONFCEEntity(int? PRODUTONFCEID, int? CUPOMELETRONICOID, int? IDPRODUTO, string NOMEPRODUTO, 
            string CODBARRA, string CODPRODUTOFORNECEDOR, decimal? QUANTIDADE, decimal? VALORUNITARIO, 
            decimal? VALORTOTAL, decimal? ALICMS, decimal? BASEICMS, decimal? REDICMS, decimal? VALORICMS, 
            decimal? ALIPI, decimal? VALORIPI, int? IDUNIDADE, string NOMEUNIDADE, int? IDCFOP, string CODCFOP,
            string DESCCFOP, decimal? ALIQPIS, decimal? VALORPIS, decimal? ALIQCOFINS, decimal? VALORCOFINS, 
            decimal? VLBASEST, decimal? VLICMSST, decimal? VLALIQST, decimal? VLOUTROS, decimal? VLTRIBUTOAPROX,
            DateTime? DTEMISSAO, int? IDVENDEDOR, int? IDSTATUSNFCE, int? ITEM, int? IDCST, string CODIGO)		{
