...
namespace BmsSoftware.Modulos.Vendas
{
    public partial class FrmAberturaCaixa : Form
    {
        ...
        LIS_ABERTURACAIXAProvider LIS_ABERTURACAIXAP = new LIS_ABERTURACAIXAProvider();
        LIS_ABERTURACAIXACollection LIS_ABERTURACAIXAColl = new LIS_ABERTURACAIXACollection();
        ...
        int _IDABERTURACAIXA = -1;
        public ABERTURACAIXAEntity Entity
        {
            get
            {
                ...
                return new ABERTURACAIXAEntity(_IDABERTURACAIXA, DATA, IDFUNCIONARIO, VALOR);
            ...
            set
            {
                if (value != null)
                {
                    _IDABERTURACAIXA = value.IDABERTURACAIXA;
        ...
        private void ExibiAberturaCaixa()
        {
           try 
            {	        
                    ...
                    LIS_ABERTURACAIXAColl =  LIS_ABERTURACAIXAP.ReadCollectionByParameter(RowsFiltroColl, "DATA DESC");

                    DataGriewDados.AutoGenerateColumns = false;
                    DataGriewDados.DataSource = LIS_ABERTURACAIXAColl;
            }
            catch (Exception ex)
            {
		        MessageBox.Show("Erro técnico: " + ex.Message);
        ...
        private void DataGriewDados_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (LIS_ABERTURACAIXAColl.Count > 0 && rowindex > -1)
            {
                ...
                if (ColumnSelecionada == 1)//Excluir
                {
                        ...
                        if (dr == DialogResult.Yes)
                        {
                            try
                            {
                                CodSelect = Convert.ToInt32(LIS_ABERTURACAIXAColl[rowindex].IDABERTURACAIXA);
                                ABERTURACAIXAP.Delete(CodSelect);
                                ExibiAberturaCaixa();
                                Entity = null;
                ...
                {
                    CodSelect = Convert.ToInt32(LIS_ABERTURACAIXAColl[rowindex].IDABERTURACAIXA);
                    Entity = ABERTURACAIXAP.Read(CodSelect);
        ...
        private void btnpdf_Click(object sender, EventArgs e)
        {
            ...
            {
                frm.TituloSelec = "Abertura do Caixa";
        ...
        {
            string RelatorioTitulo = InputBox("Título do Relatório", ConfigSistema1.Default.NomeEmpresa, "Abertura do Caixa");
