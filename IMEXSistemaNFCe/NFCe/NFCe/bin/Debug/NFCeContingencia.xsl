				...
				<td class="borda-pontilhada-botton">
					...
					<table class="NFCCabecalho" border="0">				
						<tr>
							...
							<td class="NFCCabecalho_Titulo NFCBold" align="left">BENEFIX SISTEMAS E GESTAO DE NEGÓCIOS LTDA [Ambiente de Homologação - Sem Valor Fiscal]</td>
							<!-- <td class="NFCCabecalho_SubTitulo" align="left"><xsl:value-of select="//n:infNFe/n:emit/n:xNome" /></td> -->
						</tr>						
						<tr>
					...
					<table border="0" style="width: 100%;">
						...
						<tr>
							<td class="NFCCabecalho_SubTitulo NFCBold" align="center">
								...
								<xsl:if test="$tpEmis!='9'">EMITIDA EM CONTINGÊNCIA</xsl:if>
							</td>				
						</tr>	
						<tr>
